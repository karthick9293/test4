...
import 'package:mobiremit/ui_five/page_routes.dart';
...
class AppRoutes {
  ...
  static dynamic getPage(String route) {
    ...
    return {
          AppUI.uiOne: defaultRoutes[route],
          AppUI.uiTwo: uiTwoRoutes[route],
          AppUI.uiThree: uiThreeRoutes[route],
          AppUI.uiFour: uiFourRoutes[route],
          AppUI.uiFive: uiFiveRoutes[route],
          AppUI.uiSix: uiSixRoutes[route],
          AppUI.defaultUI: defaultRoutes[route],
        }[theme] ??
        defaultRoutes[route];
  }
}
