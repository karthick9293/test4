          ...
          switch (f.FieldType) {
            ...
            case FieldType.text:
              ...
              l.add(
                textFormField(
                  key:
                      signUpController.idVerificationForm.keys[f.Id.toString()],
            ...
            case FieldType.date:
              l.add(dateField(
                ...
                topMargin: 0,
                initialDate: {
                      'DOB': DateTime(DateTime.now().year - allowedMinAge,
                    ...
                    DateTime.now(),
                firstDate: {
                      'DOB': DateTime(DateTime.now().year - 100,
                          DateTime.now().month, DateTime.now().day),
                      'dummy_idissueDate': DateTime(DateTime.now().year - 100,
                          DateTime.now().month, DateTime.now().day),
                      'IDEXPIRY': DateTime.now(),
                      'dummy_salary_date': DateTime(DateTime.now().year - 30,
                          DateTime.now().month, DateTime.now().day),
                    }[f.FzParamName] ??
                    DateTime.now(),
                lastDate: {
                      'DOB': DateTime(DateTime.now().year - allowedMinAge,
                          DateTime.now().month, DateTime.now().day),
                      'dummy_idissueDate': DateTime.now(),
                      'IDEXPIRY': DateTime(DateTime.now().year + 30,
                          DateTime.now().month, DateTime.now().day),
                      'dummy_salary_date': DateTime(DateTime.now().year + 30,
                          DateTime.now().month, DateTime.now().day),
                    }[f.FzParamName] ??
