          ...
          children: [
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Align(
                        ...
                        child:
                            chatBubble('Hello_is_there_something_we'.tr, true)),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  Padding(
                    ...
                    child: Align(
                        alignment: Alignment.centerLeft,
                        child: chatBubble('Just_let_me_know'.tr, true)),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  Padding(
                    ...
                    child: Align(
                        ...
                        child: chatBubble(
                            'Hello_is_there_something_we'.tr, false)),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  Padding(
                    ...
                    child: Align(
                        alignment: Alignment.centerRight,
                        child: chatBubble('Just_let_me_know'.tr, false)),
                  ),
                ],
              ),
            ),
            Container(
              ...
              margin: const EdgeInsets.only(
                  left: 26, right: 34, bottom: 19, top: 10),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:
                              accountController.isDark ? AppConfigs.g21 : null,
