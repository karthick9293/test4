                      ...
                      children: [
                              ...
                              transferController.selectedBeneficiary != null &&
                                  (transferController.formruleLoading ||
                                      (transferController
                                          ...
                                          false)),
                          child:
                              SendMoneyFormRule(controller: transferController),
                        ),
                        SizedBox(height: 15),
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                    cms(Fields.SendMoney_SendAmount)
                                        .textHeading!,
                              ...
                              textFormField(
                                ...
                                bottom: 0,
                                hintText:
                                    isLcyEnabled ? 'enter_amount'.tr : null,
                                ...
                                filledColor: transferController.isDark
                                    ? null
                                    : AppConfigs.w,
                                disableBorder: true,
                                borderRadius: 50,
                                ...
                                onChanged: (s) async {
                                  ...
                                  if (s.isNotEmpty) {
                                    if ((double.tryParse(s) ?? 0) < 1) {
                                      transferController
                                        ..fromAmtErr =
                                            'required minimum amount 1'
                                        ..toAmtErr = ''
                                        ..update();
                                      return;
                                    }
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(20, 15, 50, 0),
                                child: Row(
                                  spacing: 20,
                                  children: [
                                    Text(
                              ...
                              textFormField(
                                ...
                                hintText:
                                    isFcyEnabled ? 'enter_amount'.tr : null,
                                textAlign: TextAlign.right,
                                style: TS.f.copyWith(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w700,
                        ...
                        Obx(
                          () => Visibility(
                            ...
                            child:
                                transferController.loadingSourceNpurpose.isTrue
                                    ? Padding(
