...
//                         '${transaction.currencyCode} ${(double.tryParse(transaction.lcyAmount ?? '') ?? 0.0).toStringWithOptionalFixed(length)}'),
//                     contentTile(cms(Fields.MyTransaction_Fees).textHeading!,
//                         '${transaction.currencyCode} ${(double.tryParse(transaction.charges ?? '') ?? 0).toStringWithOptionalFixed(length)}'),
//                     contentTile(
//                         cms(Fields.MyTransaction_OtherCharges).textHeading!,
//                         '${transaction.currencyCode} ${0.toStringWithOptionalFixed(length)}'),
//                     contentTile(
...
//                             '${transaction.currencyCode} ${(transaction.taxAmount ?? 0).toStringWithOptionalFixed(length)}')
//                         : const SizedBox(),
//                     contentTile(
//                         cms(Fields.MyTransaction_NetPayAmount).textHeading!,
//                         '${transaction.currencyCode ?? ''} ${transaction.netAmount?.toStringWithOptionalFixed(length)}'),
...
//                             ? '${transaction.benfCurrencyCode} ${transaction.fcyAmount?.toStringWithOptionalFixed(length)}'
