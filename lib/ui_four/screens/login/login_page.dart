...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AccountController>(builder: (accountController) {
      ...
      return Scaffold(
          appBar: appBar1(accountController.selectedLanguage ?? '',
              enableBack: true),
          backgroundColor:
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                cms(Fields.PreLogin_Welcome).textHeading ??
                                    'Welcome',
                              ...
                              children: [
                                ...
                                Visibility(
                                    ...
                                    child: textFormField(
                                        labelText: 'Username',
                                        controller:
                                            accountController.ltc.usernameCtrl,
                                        // maxLength: 25,
                                        inputFormatters: [
                                          regexFormatter(
