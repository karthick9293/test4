...
//                               style: TS.f14.copyWith(color: isDark ? AppConfigs.gd7 : AppConfigs.g4),
//                               textAlign: TextAlign.start,
//                             ),
//                             const Spacer(),
//                             t.sending
...
//                                         },
//                                         child: Text(
//                                           cms(Fields.ConfirmAuthentication_ResendOTPButton).textHeading!,
//                                           style: TS.f14.copyWith(color: AppConfigs.primaryColor),
//                                           textAlign: TextAlign.start,
//                                         ),
//                                       ),
...
//                             : RowColumnButton(
//                                 reverseOrder: Box3.settings.EnableSwipeButton == true ? false : true,
//                                 isRow: Box3.settings.EnableSwipeButton == true ? false : true,
//                                 children: [
//                                   roundButton(cms(Fields.ConfirmAuthentication_ContinueButton).textHeading!, noMar: true, onTap: onValidate),
//                                   roundButton(
