...
class PreLogin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dashboardAppLogo = Get.find<AccountController>().isDark
        ? cms(Fields.Dashboard_AppLogoDark).image != ""
            ? Base64Image(
                image: cms(Fields.Dashboard_AppLogoDark).image ?? "",
                height: 70,
                width: 90,
                errorWidget: SizedBox(),
              )
            : SizedBox()
        : cms(Fields.Dashboard_AppLogo).image != ""
            ? Base64Image(
                image: cms(Fields.Dashboard_AppLogo).image ?? "",
                height: 70,
                width: 90,
                errorWidget: SizedBox(),
              )
                            ...
                            Stack(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: cms(Fields.Dashboard_HeaderBgImage)
                                              .image !=
                                          ""
                                      ? Base64Image(
                                          image: cms(Fields
                                ...
                                children: [
                                  ...
                                  dashtile2(
                                      ...
                                      (cms(Fields.QuickAccess_MyBeneficiaryIconAndText)
                                          ...
                                          .join('\n'), onTap: () {
                                    accountController.preLoginAlert(
                                        postLoginDestination: 'my_beneficiary');
