...
import '../../../custom_widgets/status_tiles.dart';

Widget benefTransTile(TransactionDetailsFz t, bool isDark) {
  return Container(
    // height: 80,
    decoration: BoxDecoration(
      border: Border(bottom: BorderSide(color: ConstColors.grey70.withOpacity(0.11))),
    ),
        ...
        Row(
          children: [
            Text(
              ...
              style: TS.f12.copyWith(color: isDark ? AppConfigs.g8f : AppConfigs.a9),
            ),
            const Spacer(),
            t.transactionStatus?.toLowerCase().contains('processing') == true || t.transactionStatus?.toLowerCase().contains('requested') == true
