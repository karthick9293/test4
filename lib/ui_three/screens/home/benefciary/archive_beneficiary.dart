        ...
        children: [
                      ...
                      Text('Unarchive_Beneficiary'.tr,
                          style: TS.f12.copyWith(
                              color: beneficiaryController.isDark
                                  ? (beneficiaryController
                                          .markedBeneficiary.isNotEmpty
                                      ? AppConfigs.w
                                      : AppConfigs.g8f)
                                  : (beneficiaryController
                                          .markedBeneficiary.isEmpty
                                      ? AppConfigs.g4
          ...
          textFormField(
              ...
              onChanged: (v) => beneficiaryController
                ..archivedBenefs = beneficiaryController.benefs
                    .where((b) =>
                        b.firstName!.toLowerCase().contains(v.toLowerCase()) &&
                        b.archive == 'A')
                    .toList()
                ..update(),
              top: 5,
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (c, i) => beneficiaryTile2(
                  b: beneficiaryController.archivedBenefs[i],
                  index: i,
                  isArchive: true),
            ),
          )
