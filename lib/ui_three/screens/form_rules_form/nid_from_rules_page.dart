...
class _NIDFormRulesPageState extends State<NIDFormRulesPage> {
  ...
  final companyLogo = Base64Image(
    image: (cms(Fields.AppMainLogo_MainLogoDark).image != null &&
            cms(Fields.AppMainLogo_MainLogoDark).image!.isNotEmpty)
        ? cms(Fields.AppMainLogo_MainLogoDark).image ?? ''
              ...
              l.add(
                Visibility(
                  ...
                  child: textFormField(
                    ...
                    style: TS.f16.copyWith(color: AppConfigs.g4),
