...
import 'package:mobiremit/core/controllers/add_beneficiary_controller.dart';
...
class AddBeneficiaryFormRules extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GlobalScaffold(
      body: GetBuilder<AddBeneficiaryController>(
        builder: (addBeneficiaryController) {
                ...
                case FieldType.number:
                  l.add(
                    Visibility(
                      ...
                      child: textFormField(
                        key:
                            addBeneficiaryController.form.keys[f.Id.toString()],
                        ...
                        onEditingComplete: () {
                          ...
                          addBeneficiaryController.form.nodes[id]
                              ?.requestFocus();
                        },
                        trailing: f.Masking != ""
                            ? GestureDetector(
          ...
          return !addBeneficiaryController.catalogueRetrieved
              // ? loader()
              ? FormShimmer()
              : Stack(
                  children: [
