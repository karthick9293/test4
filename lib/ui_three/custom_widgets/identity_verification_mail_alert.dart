...
Future<RegisterDeviceFZ?> identityVerificationMailAlert(String type,
    {required String customerCode, required String mobileNo}) async {
                    ...
                    Column(
                      children: [
                        ...
                        textFormField(
                            ...
                            controller:
                                signupCntrl.ivAttributes.idMailController,
                        ...
                        signupCntrl.ivAttributes.mailVerificationSubmit == false
                            ? roundButton(
                                ...
                                bottom: 8,
                                onTap: () async {
                                  if (signupCntrl.ivAttributes.idMailController
                                      .text.isEmpty) {
                                    signupCntrl.ivAttributes.idMailError =
                                        'required'.tr;
                                    signupCntrl.update();
                                  } else if (!signupCntrl.ivAttributes
                                      .idMailController.text.isEmail) {
                                    signupCntrl.ivAttributes.idMailError =
                                        'invalid_email'.tr;
                                    signupCntrl.update();
                                  } else {
                                    signupCntrl.ivAttributes.idMailError = '';
                                    signupCntrl
                                      ..ivAttributes.mailVerificationSubmit =
                                          true
                                      ..update();
                                    ...
                                    var updateCustReqData = {
                                      ...
                                      "Data": {
                                        ...
                                        "Email": signupCntrl
                                            .ivAttributes.idMailController.text,
                                        "MobileNo": mobileNo,
                                      },
                                    };
                                    ...
                                    if (isUpdated) {
                                      RegisterDeviceFZ? data =
                                          await ApiService().createOTP(
                                      ...
                                      if (data?.statusCode == "RMA-SUCC") {
                                        ...
                                        otpData = data;
                                        signupCntrl
                                            .ivAttributes.idMailController
                                            .clear();
                                        signupCntrl
                                          ..ivAttributes
                                              .mailVerificationSubmit = false
                                          ..update();
                                        Get.back();
                                      } else {
                                        // await Future.delayed(
                                        ...
                                        signupCntrl
                                            ...
                                            .clear();
                                        showFailAlert(
                                            content: data?.customMessageDetails
                                                    ?.messageDescription ??
                                                '');
                                        signupCntrl
                                          ..ivAttributes
