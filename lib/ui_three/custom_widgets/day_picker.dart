...
import 'package:mobiremit/core/exports/ui_three_custom_widgets.dart';
...
class _DayPickerState extends State<DayPicker> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
            ...
            return GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color:
                      isSelected ? AppConfigs.primaryColor : Colors.transparent,
      ...
      actions: [
        roundButton('Cancel'.tr,
            width: 100, isCancelButton: true, borderOnly: true, noMar: true),
        roundButton(
          'Select'.tr,
          width: 100,
          noMar: true,
