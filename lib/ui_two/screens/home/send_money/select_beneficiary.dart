...
class SelectBeneficiaryUiTwo extends StatelessWidget {
  SelectBeneficiaryUiTwo({super.key});
            ...
            actions: [
              IconButton(
                ...
                icon: Icon(
                  ...
                  color: tfc.showFavBenefOnly ? AppConfigs.primaryColor : null,
                ),
              ),
            ],
          ),
                                  ...
                                  children: [
                                    if (!tfc.showFavBenefOnly) ...[
                                      ...
                                      ListView.builder(
                                        ...
                                        itemBuilder: (c, i) {
                                          TransactionDetailsFz txn =
                                              tfc.filteredRecentTransactions[i];
                                          return Column(
                                            crossAxisAlignment:
                                                ...
                                                child: Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          bottom: 25),
                                                  child: _buildBeneficiaryTile(
                                                    beneficiaryController,
                                                    txn: txn,
                                                    onTap: () {
                                                      Get.find<MainController>()
                                                          .pop();
                                                      tfc.setBenefFromTxn(txn);
                                                    },
                                                  ),
                                                ),
                                              ),
          ...
          children: [
            Container(
              ...
              child: Center(
                child: Text(
                  getShortName(
                      fromTxn ? txn!.benfFirstName ?? '' : b!.firstName!),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          fromTxn ? txn!.beneficiaryName ?? '' : b!.name!,
                          style: TS.f16.copyWith(
                            color: beneficiaryController.isDark
                                ? AppConfigs.w
                                : AppConfigs.b,
