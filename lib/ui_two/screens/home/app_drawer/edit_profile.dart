...
import '../../../shimmers/form_shimmers.dart';
                ...
                child: dateField(
                    ...
                    lastDate: {
                          'DateOfBirth': DateTime(
                              ...
                              DateTime.now().day),
                          'IdIssueDate': DateTime.now(),
                          'IdExpiryDate': DateTime(DateTime.now().year + 30,
                              DateTime.now().month, DateTime.now().day),
                          'dummy_salary_date': DateTime(
                              DateTime.now().year + 30,
                              DateTime.now().month,
                                ...
                                : roundButton(
                                    ...
                                    if (kycController.validateEditProfile()) {
                                      ...
                                      if (kycController.frontDocPath[
                                              AppConfigs.docType] !=
                                          null) {
                                        uploadTasks.add(ApiService()
                                            .uploadMediaDocumentNew(
                                                validationValue:
                                                    Box3.customerDetailsFZ
                                                        ?.data!.idNo,
                                                file: XFile(
                                        ...
                                        uploadTasks.add(Future.value(true));
                                      }
