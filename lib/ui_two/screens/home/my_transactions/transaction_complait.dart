...
class TransactionComplaint extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AccountController>(builder: (accountController) {
      return Scaffold(
        ...
        body: GetBuilder<TransactionController>(builder: (tc) {
          final bool isComplaint =
              type == cms(Fields.TransactionComplaint_PageHeading).textHeading!;
                    ...
                    child: Padding(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            cms(Fields.SendTransactionEnquiry_Type)
                                .textHeading!,
