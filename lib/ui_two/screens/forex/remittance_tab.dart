...
class RemittanceTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.find<AccountController>()
      ...
      ..remittanceAttributes.toCurrency =
          Get.find<AccountController>().remittanceToCur
        ...
        children: [
                                ...
                                child: Center(
                                  child: Row(
                                    ...
                                    children: [
                                      Image.asset(
                                        currencyFlag(
                                          accountController.remittanceAttributes
                                                  .fromCurrency?.Code ??
                                              Box3
                                                  .companyDataFZ
                                                  ?.companySettings
                              ...
                              Expanded(
                                child: Center(
                                  child: CurrencyDropdownDashboard(
                                    value: accountController.remittanceToCur,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: textFormField(
                        ...
                        controller:
                            accountController.remittanceAttributes.remAmount,
                    ...
                    Text(
                      accountController.remittanceToCur?.Code ?? '',
                      style: TS.f20.copyWith(
                          color: accountController.isDark
                              ? AppConfigs.w
                              : AppConfigs.g4),
          ...
          accountController.buttonLoading
              ...
              : roundButton(
                  ...
                  top: 17, onTap: () async {
                  if (double.tryParse(accountController
                          .remittanceAttributes.remAmount.text) ==
                      null) {
                    accountController
                      ..remittanceAttributes.remAmountError = accountController
                              .remittanceAttributes.remAmount.text.isEmpty
                          ? 'required'.tr
                          : 'invalid'.tr
                      ..update();
                  } else {
