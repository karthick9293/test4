          ...
          .map(
            (e) => Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(style: TS.f14.copyWith(color: accountController.isDark ? AppConfigs.g8f : AppConfigs.g77, fontWeight: FontWeight.w600), e[0]),
                  SizedBox(
                    height: 2.5,
                  ),
                  Text(style: TS.f14.copyWith(color: accountController.isDark ? AppConfigs.g8f : AppConfigs.g4, fontWeight: FontWeight.w800), e[1]),
                ],
              ),
            ),
          )
