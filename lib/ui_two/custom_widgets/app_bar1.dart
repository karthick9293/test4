...
PreferredSize appBar1(String lang, {bool fromMpin = false, bool enableBack = false, String? title}) {
  return PreferredSize(
    preferredSize: Size(Get.width, 58 + MediaQuery.of(Get.context!).viewPadding.top),
          ...
          children: [
            (Box3.settings.preLogin) && enableBack
                ...
                : Column(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => Get.to(() => SelectLanguage(fromMpin: fromMpin)),
                        child: SvgPicture.asset(
                          ImagePath.language,
                          height: 30,
                          colorFilter: ColorFilter.mode(accountController.isDark ? AppConfigs.w : AppConfigs.g4, BlendMode.srcIn),
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: TS.f20.copyWith(
                      color: accountController.isDark ? AppConfigs.w : AppConfigs.bf0,
                    ),
