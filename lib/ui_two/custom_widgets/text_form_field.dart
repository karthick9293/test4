...
Widget textFormField(
    ...
    String? prefixText,
    Color? filledColor = const Color(0xFFEFF6FF),
  ...
  return GetBuilder<AccountController>(builder: (accountController) {
    ...
    return Column(
      ...
      children: [
        if (labelText != null)
          Padding(
            padding: noPad ? EdgeInsets.zero : EdgeInsets.fromLTRB(left ?? S.p, 10, right ?? S.p, 2.5),
            child: Text(
              labelText,
              style: TS.f16.copyWith(
                  color: accountController.isDark
                      ? (errorText.isEmpty ? AppConfigs.g8f : AppConfigs.errorBorderDark)
                      : (errorText.isNotEmpty ? AppConfigs.der : AppConfigs.b)),
            ),
          ),
        Container(
          height: cHeight,
                  ...
                  child: Focus(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIconConstraints: BoxConstraints(minHeight: 10, maxHeight: 20),
                        ...
                        contentPadding: contentPadding ?? EdgeInsets.fromLTRB(15, disableBorder ? 10 : 0, 15, disableBorder ? 10 : 20),
                        hintText: hintText,
                        labelText: Box3.primaryUI != AppUI.defaultUI ? null : labelText,
                        labelStyle: TS.f14.copyWith(
                            fontWeight: FontWeight.w500,
                            color: accountController.isDark
                                ? (errorText.isEmpty ? AppConfigs.g8f : AppConfigs.errorBorderDark)
                                : (errorText.isNotEmpty ? AppConfigs.der : AppConfigs.g70)),
                        hintStyle: TS.f14.copyWith(
                          fontWeight: FontWeight.w500,
                          color: accountController.isDark
                              ? (errorText.isEmpty ? AppConfigs.g8f : AppConfigs.errorBorderDark)
                              : (errorText.isNotEmpty ? AppConfigs.der : AppConfigs.g70),
