...
Widget dateField(
  ...
  return GetBuilder<AccountController>(builder: (ac) {
    return Column(
      children: [
        Container(
          padding: EdgeInsets.only(left: left, bottom: 5, top: 10),
          alignment: Alignment.centerLeft,
          child: Text(
            title ?? 'Date_of_Birth'.tr,
            style: TS.f16.copyWith(
                color: ac.isDark
                    ? (error.isEmpty ? AppConfigs.g8f : AppConfigs.errorBorderDark)
                    : (error.isNotEmpty ? AppConfigs.der : AppConfigs.b)),
          ),
        ),
        Container(
          key: key,
          ...
          decoration: BoxDecoration(
            ...
            color: ac.isDark ? AppConfigs.g21 : AppConfigs.textField,
            border: Border.all(color: error.isNotEmpty ? AppConfigs.der : Colors.transparent),
          ),
          child: Row(
            children: [
              field(
