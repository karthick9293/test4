...
Future<void> validateOTPAddBeneficiary({
  ...
  await Get.bottomSheet(
      Align(
        ...
        child: Material(
          ...
          child: GetBuilder<AddBeneficiaryController>(builder: (t) {
            return Container(
              ...
              child: Column(
                ...
                children: [
                          ...
                          : t.timeToResend.abs() != 0
                              ...
                              : GestureDetector(
                                  onTap: () async {
                                    ...
                                    RegisterDeviceFZ? resend = await ApiService().generateOTP(userIdentification: UserIdentification.addBeneficiary);
                  ...
                  Get.find<AddBeneficiaryController>().loading
