...
import 'package:mobiremit/ui_two/custom_widgets/day_picker.dart';
        ...
        children: [
          Container(
            ...
            child: Text(
              ...
              style: TextStyles.font16.copyWith(color: ac.isDark ? AppConfigs.g8f : AppConfigs.g77),
            ),
          ),
          Container(
            // key: key,
            ...
            decoration: BoxDecoration(
              ...
              color: ac.isDark ? AppConfigs.g21 : AppConfigs.primaryColor.withOpacity(0.1),
              border: Border.all(
                  color: error.isNotEmpty
                      ? AppConfigs.der
                      : ac.isDark
                ...
                Expanded(
                  child: field(
                    ...
                    onEditingComplete: () {
                      ...
                      ctrls[1].text = currentDate.month.toString().padLeft(2, '0');
