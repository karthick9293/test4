...
import 'package:mobiremit/ui_two/custom_widgets/advertisement_banner.dart';

class CustomCarouselSlider extends StatelessWidget {
  final dynamic accountController;
  final List<AdvertisementList> promotions;

  const CustomCarouselSlider({super.key, required this.accountController, required this.promotions});
