...
import 'package:mobiremit/ui_two/custom_widgets/pin_put.dart';
import 'package:mobiremit/ui_two/custom_widgets/round_button.dart';
import '../../core/exports/controllers.dart';
import '../../core/flavours/app_config.dart';
import '../../core/flavours/constants.dart';
import 'appbar_ui_two.dart';
import 'loader.dart';

class UiTwoLoginOtp extends StatelessWidget {
            ...
            Padding(
              ...
              child: Center(
                child: MpinPut(
                    ...
                    normalColor: const Color(0xFFEFF6FF),
                    onChanged: (s) {},
                    onClear: () {
                      controller?.clear();
                    }),
