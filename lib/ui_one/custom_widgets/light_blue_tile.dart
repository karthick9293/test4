...
Widget lightBlueTile(
  ...
  return GetBuilder<AccountController>(builder: (accountController) {
          ...
          .map((e) => TableRow(children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style:
                        TS.f12.copyWith(fontSize: 11, color: accountController.isDark ? AppConfigs.g8f : AppConfigs.g4, fontWeight: FontWeight.w700),
                  ),
                )
              ]))
          .toList();
    ...
    return Container(
      ...
      color: accountController.isDark ? AppConfigs.b000f14 : AppConfigs.geb.withOpacity(0.1), //Rahul changes
      child: Column(
        children: [
          Visibility(
            visible: title != null,
            child: Container(
              ...
              margin: const EdgeInsets.only(bottom: 10),
              child: Text(title ?? '',
                  style: TS.f14.copyWith(color: accountController.isDark ? AppConfigs.w : AppConfigs.g4), textAlign: TextAlign.start),
            ),
          ),
          Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: accountController.isDark ? AppConfigs.b01222d : AppConfigs.w,
                ),
                child: Center(
                  child: Text(
                      ...
                      Column(
                          children: contents!
                              ...
                              .map((e) => Text(
                                    e.contains(':') ? '${e.split(':')[0]}:' : e,
                                    style: TS.f12
                                        .copyWith(color: accountController.isDark ? AppConfigs.g8f : AppConfigs.g77, fontWeight: FontWeight.w600),
                                  ))
                              .toList()),
                      Table(
                        columnWidths: {
                          0: FixedColumnWidth(contents.any((c) => c.contains("sending_amount".tr)) ? 100 : 80),
              ...
              Container(
                constraints: BoxConstraints(maxHeight: isProfile ? 30 : 80, minHeight: 30),
                child: Column(
                  ...
                  children: [
                    allowEdit
                        ...
                        : index != null &&
                                (Get.find<BeneficiaryController>().benefs[index].serviceType == 'C' &&
                                    Get.find<BeneficiaryController>().benefs[index].isCorrespondentActive == 'Y')
                            ? Visibility(
                                visible: (Get.find<BeneficiaryController>().benefs[index].active == 'A' ||
                                    Get.find<BeneficiaryController>().benefs[index].active == 'N'),
                                child: (loading
                                    ? tinyLoader()
                                    : Padding(
                                        ...
                                        child: FlutterSwitch(
                                          ...
                                          onToggle: (v) async {
                                            ...
                                            if (v == false) {
                                              Get.dialog(yesOrNoAlert(
                                                  ...
                                                  onTap: () async {
                                                    bc
                                                      ...
                                                      ..update();
                                                    if (await ApiService()
                                                        .beneficiarytasks(bc.benefs[index].id!.toString(), BeneficiaryTasks.disable)) {
                                                      bc.benefs[index] = bc.benefs[index].copyWith(active: 'N');
                                                    }
                                              ...
                                              if (bc.benefs[index].serviceType == 'C' && bc.benefs[index].isCorrespondentActive == 'Y') {
                                                bc
                                                  ..favIndex = index
                                                  ..update();
                                                if (await ApiService().beneficiarytasks(bc.benefs[index].id!.toString(), BeneficiaryTasks.enable)) {
                                                  bc.benefs[index] = bc.benefs[index].copyWith(active: 'Y');
                                                }
                                                await d.getBeneficiaries();
                                                bc
                                                  ..benefs = d.beneficiaries
                                                  ...
                                                  ..update();
                                                Get.find<AccountController>().update();
                                              } else if (bc.benefs[index].serviceType == 'B') {
                                                bc
                                                  ..favIndex = index
                                                  ..update();
                                                if (await ApiService().beneficiarytasks(bc.benefs[index].id!.toString(), BeneficiaryTasks.enable)) {
                            ...
                            : index != null && (Get.find<BeneficiaryController>().benefs[index].serviceType == 'B')
                                ? Visibility(
                                    visible: (Get.find<BeneficiaryController>().benefs[index].active == 'A' ||
                                        Get.find<BeneficiaryController>().benefs[index].active == 'N'),
                                    child: (loading
                                                ...
                                                if (v == false) {
                                                  ...
                                                  if (bc.benefs[index].serviceType == 'C' && bc.benefs[index].isCorrespondentActive == 'Y') {
                                                    bc
                                                      ...
                                                      ..update();
                                                    if (await ApiService()
                                                        .beneficiarytasks(bc.benefs[index].id!.toString(), BeneficiaryTasks.enable)) {
                                                      bc.benefs[index] = bc.benefs[index].copyWith(active: 'Y');
                                                    }
                                                    await d.getBeneficiaries();
                                                    bc
