...
GetBuilder updateProfileBody({String? msg, required String type}) =>
    GetBuilder<KycController>(builder: (kycController) {
      String? contact =
          Get.find<AccountController>().contactUs?.data?.phoneNo.toString();
      var data = contact != null ? contact.split(':') : [];
      String customerNumber =
          data.isNotEmpty == true && data.length > 1 ? data[1] : '';
      return Align(
        ...
        child: Material(
          ...
          child: Container(
            constraints: const BoxConstraints(
                minWidth: 400, maxWidth: 400, minHeight: 270, maxHeight: 500),
              ...
              children: [
                ...
                Text(
                  ...
                  style: TS.f20.copyWith(
                      color:
                          kycController.isDark ? AppConfigs.w : AppConfigs.bf0),
                ),
                ...
                (Box3.settings.allowUpdateKYC ||
                            Box3.settings.enableEditProfile) &&
                        type != 'P'
                    ? RowColumnButton(
                        ...
                        children: [
                          ...
                          roundButton('Update Later'.tr,
                              noMar: true, isCancelButton: true)
                        ],
                      )
