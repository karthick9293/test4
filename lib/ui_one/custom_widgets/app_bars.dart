...
class AppBars {
  ...
  static PreferredSizeWidget forexRates = appBar0(cms(Fields.ForexRates_PageHeading).textHeading!);
  ...
  static PreferredSizeWidget myTransaction = appBar0(cms(Fields.MyTransaction_PageHeading).textHeading!);
