...
Future<void> sessionTimeOut({String path = '', String? message, String? title}) async {
  ...
  if (Get.isDialogOpen != true) {
    await Get.dialog(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: SelectableText(
                                message ?? 'Your session has timed out, please login again.${AppConfigs.env == Environment.prod ? '' : ' in $path'}',
        ...
        barrierColor: (Get.isRegistered<AccountController>() ? Get.find<AccountController>() : Get.put(AccountController())).isDark
