          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color: isDrawer ? AppConfigs.w : (isDark ? AppConfigs.primaryColor : AppConfigs.accentColor), width: 2),
              ...
              child: accountController.appStatus != AppStatus.loggedIn
                  ? Center(
                      child: Text(
                        ...
                        style:
                            TextStyles.font20.copyWith(color: isDrawer ? (isDark ? AppConfigs.primaryColor : AppConfigs.w) : AppConfigs.primaryColor),
                      ),
                    )
                            ...
                            errorWidget: Center(
                              child: Text(
                                ...
                                style: TextStyles.font20.copyWith(
                                  color: isDrawer ? (isDark ? AppConfigs.primaryColor : AppConfigs.w) : AppConfigs.primaryColor,
                                ),
                              ),
                            ),
                          ),
            ...
            children: [
              Row(
                children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: Text(
                        "${cms(Fields.SideMenu_HiText).textHeading!} ${preLogin ? 'User'.tr : (isDrawer ? Box3.customerDetailsFZ?.data?.firstName : Box3.customerDetailsFZ?.data?.name)}"
                            .replaceAll("  ", " "),
                        style: TS.f20.copyWith(color: isDrawer || isDark ? AppConfigs.w : c1),
                  ...
                  Visibility(
                      visible: !isDrawer && Get.find<AccountController>().kycStatus == KYCStatus.pending, child: SvgPicture.asset(SvgIcons.info)),
                  Visibility(
                    visible: !isDrawer && Get.find<AccountController>().kycStatus == KYCStatus.pending,
                    child: GestureDetector(
                      onTap: () {
                      ...
                      child: Container(
                        margin: const EdgeInsets.only(bottom: 4, left: 3, right: 14),
                        decoration: BoxDecoration(border: Border(bottom: BorderSide(color: AppConfigs.primaryColor))),
                        child: Text(
                          cms(Fields.SideMenu_CompleteKYCIconAndText).textHeading!,
                          style: TS.f12.copyWith(color: AppConfigs.primaryColor),
                        ),
                      ),
                    ),
                  ),
