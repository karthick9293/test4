                        ...
                        : Column(
                            children: [
                              textFormField(
                                ...
                                labelText: cms(Fields.FAQ_SearchFaq).textHeading ?? "",
                                onChanged: (v) {
                                  ...
                                  child: controller.text.isNotEmpty &&
                                      ...
                                      : ListView.builder(
                                          ...
                                          itemBuilder: (c, i) {
                                            ...
                                            return Visibility(
                                              visible: e.Question.toLowerCase().contains(controller.text.toLowerCase()) ||
                                                  e.Answer.toLowerCase().contains(controller.text.toLowerCase()),
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    accountController.faqs![i].Question,
                                                    style: TS.f14.copyWith(
                                                        color: accountController.isDark ? AppConfigs.w : AppConfigs.g4, fontWeight: FontWeight.bold),
                                                    textAlign: TextAlign.justify,
                                                  ),
                                                  const SizedBox(height: 10),
                                                  Text(accountController.faqs![i].Answer,
