        ...
        child: ListView(
          ...
          children: [
            textFormField(
              ...
              controller: mainController.pwdAttributes.currentPasswordController,
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  mainController.pwdAttributes.currentObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
            ...
            textFormField(
              ...
              onChanged: (v) {
                mainController
                  ..pwdAttributes.passwordStrength = (v.contains(RegExp(r'[A-Z]')) ? 0.20 : 0) +
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  mainController.pwdAttributes.newObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
                  color: AppConfigs.g77,
                ),
              ),
                  ...
                  Container(
                    ...
                    child: TweenAnimationBuilder<double>(
                      ...
                      builder: (context, value, w) => LinearProgressIndicator(
                        value: value,
                        color: value < 0.5
                            ? Color.alphaBlend(const Color(0xffc11010).withOpacity((0.5 - value) * 2), Colors.yellow.withOpacity(value * 2))
                            : Color.alphaBlend(Colors.yellow.withOpacity(1 - value), Colors.green.withOpacity(value)),
                        // value < 0.2
                  ...
                  Container(
                    ...
                    child: Text(
                        mainController.pwdAttributes.passwordStrength < 0.20
                            ? 'weak'.tr
                            : mainController.pwdAttributes.passwordStrength < 0.81
                                ? 'Medium'.tr
                                : 'Strong'.tr,
                        style: TS.f14),
                  ),
                  textConstratint(
                      'contains_at_least_one_uppercase'.tr, mainController.pwdAttributes.newPasswordController.text.contains(RegExp(r'[A-Z]'))),
                  textConstratint(
                      'contains_at_least_one_lowercase'.tr, mainController.pwdAttributes.newPasswordController.text.contains(RegExp(r'[a-z]'))),
                  textConstratint(
                      'contains_at_least_one_number'.tr, mainController.pwdAttributes.newPasswordController.text.contains(RegExp(r'[0-9]'))),
                  textConstratint('contains_at_least_one_special_char'.tr,
                      mainController.pwdAttributes.newPasswordController.text.contains(RegExp(r'[!@#\$&*~]'))),
                  textConstratint('Password length 8-15 characters', mainController.pwdAttributes.newPasswordController.text.length > 7),
                ],
              ),
            ),
            textFormField(
              ...
              inputFormatters: [regexFormatter("[A-Za-z0-9!@#\$%&*]+")],
              keyboardType: TextInputType.emailAddress,
              controller: mainController.pwdAttributes.confirmPasswordController,
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  mainController.pwdAttributes.confirmObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
                  color: AppConfigs.g77,
                ),
              ),
                    ...
                    onTap: () async {
                      if (!mainController.pwdAttributes.validate('Password')) {
                        ...
                        String? s = await ApiService().changelogincredential(
                            oldCred: mainController.pwdAttributes.currentPasswordController.text,
                            newCred: mainController.pwdAttributes.confirmPasswordController.text,
                        ...
                        await Future.delayed(const Duration(seconds: 2));
                        if (mainController.pages.last.runtimeType == ChangePassword && s == 'SUCCESS') {
