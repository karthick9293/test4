...
Widget roundButton(String text,
    ...
    bool isLoading = false, double? radius,
    Key? key}) {
  return Box3.settings.EnableSwipeButton == true
      ? Container(
          ...
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(radius??10), border: Border.all(color: isCancelButton ? AppConfigs.primaryColor : Colors.transparent)),
      ...
      : GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.all(radius!=null?Radius.circular(radius):Radius.circular(15)),
                border: Border.all(color: isLoading ? AppConfigs.primaryColor.withOpacity(0) : borderColor ?? ConstColors.primary, width: 2)),
            alignment: Alignment.center,
            child: isLoading
                ? loaderIcon()
                : child ??
