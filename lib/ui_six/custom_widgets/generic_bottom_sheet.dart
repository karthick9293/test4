        ...
        return GestureDetector(
          onTap: enable == true
              ? () async {
                          ...
                          child: Column(
                            children: [
                              ...
                              textFormField(
                                  ...
                                  bottom: 10,
                                  filledColor: isDark ? Colors.black : null,
                                  onChanged: (v) async {
                                    search = v;
                                    onSearchEvent(
                                      v,
                  ...
                  if (f != null &&
                      signUpController.list[f.FzParamName]!.isEmpty &&
                      !signUpController.loadingSources
                          .contains(f.FzParamName)) {
                    await signUpController.reFetchSources(f, currentForm: form);
                  }
                }
              : null,
          child: enableSecondTheme
              ? Column(
                  ...
                  children: [
                    ...
                    //               color: Get.find<TransferController>().isDark
                    //                   ? AppConfigs.g8f
                    //                   : AppConfigs.g4),
                    //         ),
                    //
