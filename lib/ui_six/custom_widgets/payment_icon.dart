              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: transferController.isDark
                        ? (transferController.gateWay?.description == e.description ? AppConfigs.accentColor : AppConfigs.g21)
                        : AppConfigs.w,
                    borderRadius: const BorderRadius.all(Radius.circular(7)),
                    boxShadow: [
                      BoxShadow(
                        color: (transferController.isDark ? AppConfigs.w : AppConfigs.b).withOpacity(0.36),
                        blurRadius: 10,
                      )
                    ],
                  ),
                ...
                Visibility(
                  visible: transferController.gateWay?.description == e.description || (transferController.gateWay?.type == 'P' && e.type == 'G'),
                  child: SvgPicture.asset(ImagePath.transactionDone, height: 40),
                )
              ],
            ),
          ),
