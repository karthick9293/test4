            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TS.f18.copyWith(color: transactionController.isDark ? AppConfigs.w : AppConfigs.g4),
              ...
              Text(
                ...
                style: TS.f14.copyWith(
                  color: transactionController.isDark ? AppConfigs.w : AppConfigs.g4,
                ),
              ...
              GetBuilder<TransactionController>(
                  ...
                  builder: (txnContrl) {
                    return Row(
                      children: [
                        Expanded(
                          child: _buildDownloadType(txnContrl, typeIdx: 0, text: 'download'.tr),
                        ),
                        Expanded(
                          child: _buildDownloadType(txnContrl, typeIdx: 1, text: 'email'.tr),
                        ),
                      ],
                    );
                  }),
                  ...
                  children: [
                    TextSpan(
                      ...
                      style: TS.f16.copyWith(
                        color: transactionController.isDark ? AppConfigs.w : AppConfigs.g70,
                      ),
                    ),
                    TextSpan(
                      text: 'PDF format.'.tr,
              ...
              //   noPad: true,
              // ),
              transactionController.isError == true ? errorText("Select_Format".tr) : const SizedBox(),
              const SizedBox(height: 10),
              RowColumnButton(isRow: Box3.settings.EnableSwipeButton == true ? false : true, children: [
                roundButton(
                  'cancel'.tr,
                  noMar: true,
                  borderOnly: true,
                ...
                roundButton(cms(Fields.PopUp_Confirm).textHeading ?? 'confirm'.tr, noMar: true, onTap: () async {
...
GestureDetector _buildDownloadType(TransactionController transactionController, {required String text, required int typeIdx}) {
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          ...
          style: TS.f16.copyWith(
            fontWeight: FontWeight.w600,
            color: transactionController.statementIndex == typeIdx ? AppConfigs.primaryColor : AppConfigs.g4,
          ),
        ),
      ],
    ),
