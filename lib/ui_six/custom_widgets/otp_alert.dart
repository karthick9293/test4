            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Align(
                      alignment: Alignment.center,
                      child: cms(Fields.ConfirmAuthentication_Image).image != ""
                          ? Base64Image(image: cms(Fields.ConfirmAuthentication_Image).image!)
                          ...
                          : t.timeToResend.abs() != 0
                              ...
                              : GestureDetector(
                                  onTap: () async {
                                    ...
                                    RegisterDeviceFZ? resendResponse = await ApiService().createOTP(validationValue);
                                  ...
                                  child: t.otpMessage.isEmpty == true
                                      ? Text(cms(Fields.ConfirmAuthentication_ResendOTPButton).textHeading!,
                                          style: TS.f14.copyWith(color: AppConfigs.primaryColor), textAlign: TextAlign.start)
                                      : const SizedBox(),
                                )
                    ],
                  ...
                  t.otpMessage.isEmpty == true
                      ? const SizedBox()
                      : Text(t.otpMessage, style: TS.f14.copyWith(color: AppConfigs.primaryColor), textAlign: TextAlign.start),
                  t.otpMessage.isEmpty == true
                      ? const SizedBox()
                      : const SizedBox(
                          height: 5,
