...
Widget titleText1(String title, bool isDark,{double? bottom}) {
  return Container(
    padding: EdgeInsets.only(left: 20, top: 10,bottom: bottom ?? 5),
    alignment: Alignment.centerLeft,
    child: Text(title.toUpperCase(),
        style: TS.f14.copyWith(color: isDark ? AppConfigs.g8f : AppConfigs.primaryColor.withOpacity(0.8),fontWeight: FontWeight.w900), textAlign: TextAlign.start),
  );
}
