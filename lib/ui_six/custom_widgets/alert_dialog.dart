      ...
      child: Container(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              //       spreadRadius: 0)
              // ],
              color: accountController.isDark ? AppConfigs.b.withAlpha(200) : AppConfigs.w),
          child: Material(
                    ...
                    : Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              title,
                              style: TS.f20.copyWith(color: accountController.isDark ? AppConfigs.w : AppConfigs.g4, fontWeight: FontWeight.bold),
                            ),
                          ),
                        ],
                      ),
              ...
              children: [
                ...
                ConstrainedBox(
                  ...
                  child: SingleChildScrollView(
                    ...
                    message ?? '',
                    style: TS.f14.copyWith(color: accountController.isDark ? AppConfigs.w.withAlpha(200) : null),
                  ))),
                ),
                roundButton(
                  cms(Fields.PopUp_OkButton).textHeading!,
    ...
    Material(
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: isDark ? AppConfigs.g21 : AppConfigs.w),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Center(
