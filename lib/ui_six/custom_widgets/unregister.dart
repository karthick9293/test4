              ...
              children: [
                Column(
                  children: [
                          ...
                          Visibility(
                            ...
                            child: Row(
                              children: [
                                ...
                                SelectableText(
                                  Box3.deviceId ?? '',
                                  style: TS.f14.copyWith(color: Get.find<AccountController>().isDark ? AppConfigs.w : AppConfigs.g4),
                                ),
                                const Spacer(),
                                const Icon(
                                  Icons.copy,
                    ...
                    Row(
                      children: [
                        Expanded(child: roundButton('Cancel', top: 0, right: 10)),
                        Expanded(
                          child: buttonLoading
                              ? loader(top: 15, bottom: 15)
                              : roundButton(buttonText, top: 0, left: 10, onTap: () async {
                                  buttonLoading = true;
                                  ...
                                  if (result) {
                                    ...
                                    Get.find<AccountController>().appStatus = AppStatus.onBoarded;
