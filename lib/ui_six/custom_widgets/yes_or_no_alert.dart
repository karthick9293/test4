...
Widget yesOrNoAlert({Function()? onTap, bool? hideIcon, required String title, required String body, String? yesText, String? noText}) {
        ...
        child: Material(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: hideIcon != true
                        ...
                        : Text(
                            title,
                            style: TextStyles.font20.copyWith(color: accountController.isDark ? AppConfigs.w : AppConfigs.g4),
                          ),
                  ),
                ],
              ),
              ...
              Text(
                body,
                style: TextStyles.font12.copyWith(color: accountController.isDark ? AppConfigs.w : const Color(0xff888787)),
              ),
              const SizedBox(
                height: 20,
              ),
              accountController.isYesNoLoader
                  ...
                  : RowColumnButton(
                      ...
                      children: [
                        roundButton(yesText ?? cms(Fields.PopUp_YesButton).textHeading!, noMar: true, onTap: onTap),
                        roundButton(
