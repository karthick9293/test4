...
Future<void> errorAlert({required String content, String? title, Function()? function}) async {
  var mainCtrl = Get.isRegistered<MainController>() ? Get.find<MainController>() : Get.put(MainController());
...
Future<void> cbLimitErrorAlert({required String content, String? title, Function()? function, String? currencySymbol, String? amount}) async {
  var mainCtrl = Get.isRegistered<MainController>() ? Get.find<MainController>() : Get.put(MainController());
  if (Get.isDialogOpen == true) Get.back();
  bool isDark = mainCtrl.isDark;
  await Get.dialog(
