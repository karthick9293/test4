          ...
          children: [
            Container(
              ...
              child: Text(
                ...
                style: TextStyles.font16.copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: a.isDark ? AppConfigs.w : AppConfigs.g8f),
              ),
            ),
            textFormField(
              labelText: authenticationMethod2 == 'MPIN' ? 'New_MPIN'.tr : 'new_password'.tr,
              bottom: 10,
              inputFormatters: [
              ...
              keyboardType: authenticationMethod2 == 'MPIN' ? TextInputType.number : TextInputType.emailAddress,
              maxLength: authenticationMethod2 == 'MPIN' ? 6 : 8,
              controller: a.fptc.newPwd,
              errorText: a.fptc.newPwddErrTxt,
              onChanged: (v) {
                if (a.fptc.newPwddErrTxt.isNotEmpty && a.fptc.newPwd.text.isNotEmpty) {
                  a.fptc.newPwddErrTxt = '';
                }
                a
                  ..forgotPwdStrength = (v.contains(RegExp(r'[A-Z]')) ? 0.33 : 0) +
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  a.attributes.newObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
            ...
            Visibility(
              ...
              child: TweenAnimationBuilder<double>(
                ...
                builder: (context, value, _) => Container(
                    margin: const EdgeInsets.only(left: 20, bottom: 8, right: 20, top: 0),
                    child: ClipRRect(
            ...
            Visibility(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    textConstratint('contains_at_least_one_uppercase'.tr, a.fptc.newPwd.text.contains(RegExp(r'[A-Z]'))),
                    textConstratint('contains_at_least_one_lowercase'.tr, a.fptc.newPwd.text.contains(RegExp(r'[a-z]'))),
                    textConstratint('contains_at_least_one_number'.tr, a.fptc.newPwd.text.contains(RegExp(r'[0-9]'))),
                    textConstratint('contains_at_least_one_special_char'.tr, a.fptc.newPwd.text.contains(RegExp(r'[!@#\$&*~]'))),
                    textConstratint('Password length 8-$pwdMaxLength characters', a.fptc.newPwd.text.length > 7)
                  ],
                ),
              ),
            ),
            textFormField(
              labelText: authenticationMethod2 == 'MPIN' ? 'Confirm_MPIN'.tr : 'confirm_password'.tr,
              bottom: 0,
              top: 17,
              ...
              maxLength: authenticationMethod2 == 'MPIN' ? 6 : 8,
              onChanged: (v) {
                if (a.fptc.cnfPwdErrTxt.isNotEmpty && a.fptc.confPwd.text.isNotEmpty) {
                  a.fptc.cnfPwdErrTxt = '';
                }
                a.update();
              },
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  a.attributes.confirmObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
                  color: AppConfigs.g77,
                ),
              ),
            ...
            a.buttonLoading
                ? loader(top: 20)
                : roundButton(cms(Fields.PopUp_Submit).textHeading!, top: 20, onTap: () async {
                    if (a.fptc.validate(authenticationMethod2: authenticationMethod2)) {
                      a
                        ..buttonLoading = true
                        ..update();
                      bool status = authenticationMethod2 == 'MPIN'
                          ? await ApiService().resetMpin(
                              validationValue:
                                  Box3.settings.processEkycAs == 'UAEPASS' ? a.ltc.usernameCtrl.text : Box3.customerDetailsFZ?.data!.idNo ?? '',
                      ...
                      if (status) {
                        ...
                        Get.dialog(successAlert(a.isDark, content: '${authenticationMethod2 == 'MPIN' ? 'MPIN' : 'Password'} Changed successfully'));
