...
class _ForgotUsernameFormRuleState extends State<ForgotUsernameFormRule> {
  ...
  void initializeControllers() {
    for (var field in a.forgotUsernameFormFZ!.formFieldItem) {
      a.forgotUsernameForm.textFieldControllers[field.FzParamName] =
    ...
    return GetBuilder<AccountController>(builder: (accountController) {
      List<Widget> children() {
        ...
        List<FormFieldItem> fields =
            accountController.forgotUsernameFormFZ!.formFieldItem.toList()
          ...
          switch (f.FieldType) {
            case FieldType.number:
              ...
              l.add(
                Visibility(
                  ...
                  child: textFormField(
                      controller: accountController.forgotUsernameForm
                      ...
                      focusNode: accountController
                          .forgotUsernameForm.nodes[f.FzParamName],
                      keyboardType:
                      ...
                      trailing: trailingIcon != null
                          ...
                          : null,
                      onChanged: (v) {
                        if (accountController.forgotUsernameForm
                            .errorTexts[f.FzParamName]!.isNotEmpty) {
                          accountController.forgotUsernameForm
                      ...
                      onEditingComplete: () {
                        String? id = accountController
                            .forgotUsernameFormFZ?.formFieldItem
                            .toList()
                            .firstWhereOrNull((f0) =>
                                f0.index == f.index + 1 &&
                            ...
                            ?.FzParamName;
                        if (id != null) {
                          accountController.forgotUsernameForm.nodes[id]
                              ?.requestFocus();
                        } else {
              ...
              l.add(
                textFormField(
                    controller: accountController
                        .forgotUsernameForm.textFieldControllers[f.FzParamName],
                    labelText: f.FieldDisplayName + (f.optional ? '' : ' *'),
                    inputFormatters: f.Regex.isNotEmpty
                        ? [FilteringTextInputFormatter.allow(RegExp(f.Regex))]
                        : null,
            ...
            case FieldType.date:
              l.add(dummyTextField(
                  accountController.forgotUsernameForm.dates[f.FzParamName],
                ...
                if (d != null) {
                  accountController
                    ..forgotUsernameForm.dates[f.FzParamName] =
            ...
            case FieldType.dropDownSingle:
              l.add(genericBottomSheet(
                  ...
                  labelText: '${f.FieldDisplayName}${f.optional ? '' : ' *'}',
                  value: accountController.forgotUsernameForm
                ...
                children: [
                  ...
                  Wrap(
                    children: (f.setOptions() ??
                            accountController
                                .forgotUsernameForm.sources[f.ApiKey]!)
                        .toList()
                        .map(
                          (e) => Padding(
      ...
      return Scaffold(
        ...
        appBar: appBar0(cms(Fields.ForgotUserName_PageHeading).textHeading!,
            onTap2: Get.back),
            ...
            children: [
              Container(
                ...
                child: ConstrainedBox(
                  ...
                  child: cms(Fields.ForgotUserName_Image).image != ""
                      ? Base64Image(
                          image: cms(Fields.ForgotUserName_Image).image!)
              ...
              ...accountController.forgotUsernameFormFZ == null
                  ...
                  : [
                      ...children(),
                      FormLoggerView(
                          formName: FormNames.forgotUsernameFormRules,
                          formRuleData: accountController.forgotUsernameFormFZ),
                      accountController.buttonLoading
                          ? loader(top: 20, bottom: 5)
                          : roundButton(
                              cms(Fields.ForgotUserName_SendButton)
                                  .textHeading!,
                              top: 20,
                              bottom: 5, onTap: () async {
                              bool status = accountController.forgotUsernameForm
                              ...
                              if (status) {
                                ...
                                try {
                                  var formData = accountController
                                      .forgotUsernameForm
                                      .buildJsonNew(accountController
                                          .forgotUsernameFormFZ!.formFieldItem);

                                  await a.forgetMpin(
                                      stepOrderId: "0", data: formData);
                                } catch (e) {
                                  if (kDebugMode) {
                      ...
                      Center(
                        child: GestureDetector(
                          ...
                          child: Text(
                              ...
                              cms(Fields.ForgotUserName_HomeButton)
                                  .textHeading!,
