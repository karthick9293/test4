...
class ForexTab extends GetView {
  ...
  Widget build(BuildContext context) {
    Get.find<AccountController>()
      ...
      ..forexAttributes.toCurrency = Get.find<AccountController>().toCur
        ...
        children: [
              ...
              children: [
                                ...
                                child: Center(
                                  child: CurrencyDropdownDashboard(
                                    ...
                                    crItems: accountController.currencies
                                        .where((c) =>
                                            c.id != Box3.companyDataFZ?.companySettings?.primaryBaseCurrency &&
                                            c.Desc != accountController.forexAttributes.fromCurrency?.Desc)
                                        .toList(),
                                    onChanged: (c) async {
                                      accountController
                                        ...
                                        ..toCur = c
                                        ..update();
                                      await accountController.getRateOnAlert(false);
                                    },
                            ...
                            children: [
                              Container(
                                ...
                                child: textFormField(
                                  ...
                                  controller: accountController.forexAttributes.forAmount,
                                  keyboardType: const TextInputType.numberWithOptions(signed: false, decimal: true),
                                  textAlign: TextAlign.center,
                                  onChanged: (s) {
                                    if (s.isNotEmpty) {
                                      accountController.forexAttributes.forAmountError = '';
                                    }
                                    accountController.update(["rate-text-field"]);
                                  },
                                  style: TS.f20.copyWith(color: accountController.isDark ? AppConfigs.g8f : AppConfigs.g4),
                                  cHeight: 49,
                                  noPad: true,
                                ),
                              ),
                              accountController.forexAttributes.forAmountError.isNotEmpty
                                  ? errorText(accountController.forexAttributes.forAmountError)
                                  : const SizedBox(
                                      height: 5,
                                    ),
                            ],
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("1 ${Box3.companyDataFZ?.companySettings?.primaryBaseCurrency ?? accountController.forexAttributes.fromCurrency!.Code} = ",
                          style: TS.f12.copyWith(color: accountController.isDark ? AppConfigs.w : AppConfigs.g4), textAlign: TextAlign.start),
                      Text('${accountController.oneForRate} ${accountController.forexAttributes.toCurrency!.Code}',
                          style: TS.f12.copyWith(color: accountController.isDark ? AppConfigs.w : AppConfigs.g4), textAlign: TextAlign.start)
                    ],
                  ),
                ),
          ...
          accountController.buttonLoading
              ...
              : roundButton(cms(Fields.ForexBooking_SetAlertButton).textHeading!, top: 17, onTap: () async {
                  if (double.tryParse(accountController.forexAttributes.forAmount.text) == null) {
                    accountController
                      ..forexAttributes.forAmountError = accountController.forexAttributes.forAmount.text.isEmpty ? 'required'.tr : 'invalid'.tr
                      ..update();
                  } else {
