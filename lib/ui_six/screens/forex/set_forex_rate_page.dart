            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: acContrl.isDark ? const Color(0xff00101d) : const Color(0xfff8f8f8),
                ),
                child: Column(
                  children: [
                    Container(
                          ...
                          Row(
                            ...
                            children: [
                              Text(cms(Fields.ForexBooking_CurrencyYouHave).textHeading!,
                                  style: TS.f12.copyWith(color: acContrl.isDark ? AppConfigs.g8f : AppConfigs.g4), textAlign: TextAlign.start),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: Center(
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Image.asset(
                                                        currencyFlag(aCtrl.remittanceAttributes.fromCurrency?.Code ??
                                                      ...
                                                      Text(
                                                          aCtrl.remittanceAttributes.fromCurrency?.Code ??
                                                              Box3.companyDataFZ?.companySettings?.primaryBaseCurrency ??
                                                              '',
                                              ...
                                              Expanded(
                                                ...
                                                value: aCtrl.remittanceAttributes.toCurrency,
                                                ...
                                                onChanged: (c) async {
                                                  aCtrl
                                                    ...
                                                    ..update(["CurrencyPicker"]);
                                                  await aCtrl.getRateOnAlert(true);
                                                },
                        ...
                        if (status) {
                          ...
                          CustomMessageDetailsFZ? customMsgDetails = await ApiService().setForexRate(
                              ...
                              date: DateFormat("dd/MMM/yyyy")
                                  .format(DateTime(
                                      int.parse(accountController.fBA!.forexDateCtrls[2].text),
                                      int.parse(accountController.fBA!.forexDateCtrls[1].text),
