...
Widget userExistsAlert(bool isDark, {String? svgIcon, String? title, Widget? body}) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TS.f20.copyWith(color: isDark ? AppConfigs.w : AppConfigs.bf0),
              ),
...
Widget successAlert(bool isDark, {String? content, double height = 167}) => Align(
      alignment: Alignment.center,
      child: Material(
        color: Colors.transparent,
        child: Container(
...
Widget kycPendingAlert(bool isDark, String text, {String? title, String? imagePath, String? image}) => Material(
      color: Colors.transparent,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  roundButton(cms(Fields.PopUp_OkButton).textHeading!, left: 0, right: 0, top: 15, bottom: 0, onTap: () {
                    Get.back();
                  })
                ],
              ),
