...
class DocumentSharingPage extends StatelessWidget {
  ...
  const DocumentSharingPage(this.kycBV, this.authToken, this.isFromSignup, {super.key});
              ...
              children: [
                ...
                signUpController.uaePassLoading
                    ...
                    : UAEButton(
                        ...
                        onTap: () async {
                          await signUpController.documentSharingRequest(authToken: authToken, uaePassProfileFz: kycBV, isFromPopup: false);
                        },
                      ),
                HyperLinkButton(
                  'Cancel',
