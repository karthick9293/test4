          ...
          children: [
            Expanded(
              child: ListView(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(bottom: 12, left: 30, right: 30, top: 30),
                    child: Container(
                        ...
                        children: [
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style:
                                      TextStyles.font14.copyWith(fontWeight: FontWeight.w700, color: accountController.isDark ? AppConfigs.w : null),
                                ),
                              ],
                            ),
                          ),
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyles.font10.copyWith(fontWeight: FontWeight.w300, color: accountController.isDark ? AppConfigs.g8f : null),
                            ),
                          ),
                        ],
                      ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(bottom: 21, left: 30, right: 30, top: 0),
                    child: Container(
                      width: double.infinity,
                      height: 77,
                      decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 45),
                            child: Text(
                              'suitable_for_business_and_freelancer_to_send_and_receive'.tr,
                              style: TextStyles.font10.copyWith(fontWeight: FontWeight.w300, color: accountController.isDark ? AppConfigs.g8f : null),
                            ),
                          ),
                        ],
                  ...
                  Padding(
                      padding: const EdgeInsets.only(bottom: 14, left: 30, right: 30),
                      child: RowColumnButton(
                        isRow: Box3.settings.EnableSwipeButton == true ? false : true,
                        children: [
                          roundButton('save'.tr, noMar: true),
                          roundButton('next'.tr, borderOnly: true, noMar: true, onTap: () => Get.toNamed(AppRoutes.signUp)),
                        ],
                      )),
                  Text(
