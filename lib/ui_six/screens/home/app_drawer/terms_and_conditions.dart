  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AccountController>(builder: (accountController) {
      return Scaffold(
        ...
        appBar: isPreLogin ? appBar0(cms(Fields.TermsAndConditions_PageHeading).textHeading!, onTap2: Get.back) : null,
        body: Container(
          decoration: BoxDecoration(
              gradient: AppConfigs.linearGradientUiSix
          ),
          child: accountController.termsAndConditions == null && !accountController.termsAndConditionsFailed
              ? Center(child: loader())
