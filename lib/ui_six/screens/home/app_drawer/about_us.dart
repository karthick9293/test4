  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AccountController>(builder: (accountController) {
      return Scaffold(
          ...
          appBar: fromPrelogin ? appBar0(cms(Fields.AboutUs_PageHeading).textHeading!, onTap2: Get.back) : null,
          body: Container(
            decoration: BoxDecoration(
                gradient: AppConfigs.linearGradientUiSix
            ),
            child: accountController.aboutUS == null && !accountController.aboutUSFailed
                ? Center(child: loader())
                    ...
                    : SafeArea(
                        child: Padding(
                          ...
                          child: SingleChildScrollView(
                            child: Html(
                              data: accountController.aboutUS!.replaceAll("[", "<b>").replaceAll("]", "</b>"),
                              style: {
                                "body": Style(
