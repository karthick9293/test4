...
import 'package:mobiremit/ui_six/custom_widgets/base64_to_image.dart';
import 'package:mobiremit/ui_six/custom_widgets/flip_card.dart';
import 'package:mobiremit/ui_six/shimmers/profile_shimmers.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AccountController>(builder: (accountController) {
      ...
      List<List<String>> children() {
        ...
        List<FormFieldItem> fields = accountController.myProfileFormBV!.formFieldItem.toList();
        ...
        for (FormFieldItem f in fields) {
          ...
          switch (f.FieldType) {
            case FieldType.text:
              ...
              String displayValue = customerData?[f.FzParamName]?.toString() ?? '';
              if (f.FzParamName == "GenderCode") {
                displayValue = customerData?['Gender'] ?? customerData?[f.FzParamName];
              }
      ...
      return Container(
        ...
        child: accountController.myProfileFormLoading
            ...
            : accountController.myProfileFormBV == null
                ? Center(
                    child: Text("My Profile formRule not loaded \nPlease go back and try again"),
                    ...
                    children: [
                              ...
                              child: Stack(
                                children: [
                                  Container(
                                    ...
                                    height: 66,
                                    width: 66,
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(33), color: ConstColors.greyd7),
                                    child: accountController.selfieImage.value != null
                                        ? ClipRRect(
                                            borderRadius: BorderRadius.circular(33),
                                            child: Base64Image(
                                              image: accountController.selfieImage.value!,
                                              height: 250,
                                              fit: BoxFit.cover,
                                            ),
                                          )
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TS.f22.copyWith(color: accountController.isDark ? AppConfigs.w : AppConfigs.g14),
                                  ),
                                  Row(
                                    children: [
                                      Padding(
                      ...
                      lightBlueTile(
                        ...
                        onEdit: () {
                          ...
                          Get.put(KycController()).profileAttributes = ProfileAttributes();
                          Get.to(() => const EditProfilePage());
                        },
                        title: cms(Fields.MyProfile_PersnalDetails).textHeading!,
                        more: Container(
                          margin: const EdgeInsets.only(top: 20),
                          padding: const EdgeInsets.all(10),
                          decoration: BoxDecoration(
                            color: AppConfigs.w.withOpacity(0.8),
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(color: AppConfigs.primaryColor.withOpacity(0.1)),
                          ),
                          alignment: Alignment.centerLeft,
                          child: singleHeadAndContentColumn(children(), c: CrossAxisAlignment.start),
                        ),
                      ),
                          ...
                          children: [
                            Center(
                              child: Column(
                                children: [
                                  FlipCardWidget(
                                    frontImage: accountController.frontImage,
                                    backImage: accountController.backImage,
                                  ),
                                  Obx(
                                    () => AnimatedSmoothIndicator(
                                      activeIndex: accountController.idSideActiveIdx.value,
                                      count: 2,
                                      effect: SwapEffect(
                                        ...
                                        activeDotColor: AppConfigs.primaryColor,
                                      ),
                                    ),
                                  ),
                                ],
