        ...
        child: ListView(
          ...
          children: [
            ...
            textFormField(
              ...
              controller: mainController.pinAttributes.currentPasswordController,
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  mainController.pinAttributes.currentObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
            ...
            textFormField(
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  mainController.pinAttributes.newObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
                  color: AppConfigs.g77,
                ),
              ),
            ...
            textFormField(
              ...
              inputFormatters: [FilteringTextInputFormatter.digitsOnly],
              keyboardType: TextInputType.number,
              controller: mainController.pinAttributes.confirmPasswordController,
              ...
              trailing: GestureDetector(
                ...
                child: Icon(
                  mainController.pinAttributes.confirmObscure ? Icons.visibility_off : Icons.visibility,
                  size: 20,
                  color: AppConfigs.g77,
                ),
              ),
            ...
            mainController.buttonLoading
                ...
                : roundButton(
                    ...
                    onTap: () async {
                      ...
                      final currentMPIN = pinAttr.currentPasswordController.text.trim();
                      final newMPIN = pinAttr.newPasswordController.text.trim();
                      final confirmMPIN = pinAttr.confirmPasswordController.text.trim();

                      bool isValid = true;

                      // Validate Current MPIN
                      if (currentMPIN.length != 6) {
                        pinAttr.currentErrorText = 'Please enter your 6-digit current MPIN';
                        isValid = false;
                      } else {
                      ...
                      // Validate New MPIN
                      if (newMPIN.length != 6) {
                        pinAttr.newErrorText = 'Please enter a valid 6-digit new MPIN';
                        isValid = false;
                      } else {
                      ...
                      if (confirmMPIN.length != 6) {
                        pinAttr.confirmErrorText = 'Please enter a valid 6-digit confirm MPIN';
                        isValid = false;
                      ...
                      Get.showSnackbar(GetSnackBar(
                        messageText: Text(
                          s == 'SUCCESS' ? '${'MPIN'.tr}${' changed Successfully'.tr}' : 'Invalid ${'MPIN'.tr}',
                      ...
                      await Future.delayed(const Duration(seconds: 2));
                      if (mainController.pages.last.runtimeType == ChangeMPIN && s == 'SUCCESS') {
                        pinAttr.clear();
                        mainController.pop();
                      }
                    },
