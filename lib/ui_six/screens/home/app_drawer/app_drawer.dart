...
class AppDrawerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    images['Admin Settngs'.tr] = ImagePath.gear;
    images['Pre-Login'.tr] = ImagePath.gear;
    images['refer_earn'.tr] = ImagePath.gear;
    images['rate_app'.tr] = ImagePath.star6;
    images[cms(Fields.SideMenu_BranchLocatorIconAndText).textHeading!] =
        ImagePath.bank;
    if (Box3.settings.enableLoyalty == true) {
      images[cms(Fields.SideMenu_OffersIconAndText).textHeading!] =
    ...
    images[cms(Fields.SideMenu_ContactUsIconAndText).textHeading!] =
        ImagePath.speechBalloon;
    images[cms(Fields.SideMenu_FaqIconAndText).textHeading!] = ImagePath.pageFaceUp;
    images[cms(Fields.SideMenu_ReportFraudIconAndText).textHeading!] =
        ImagePath.warning6;
    ...
    appBar[cms(Fields.SideMenu_BranchLocatorIconAndText).textHeading!] =
        AppBars.branchLocator;
    if (Box3.settings.enableLoyalty == true) {
      appBar[cms(Fields.SideMenu_OffersIconAndText).textHeading!] =
          AppBars.offer;
    }
    // appBar['rate_app'.tr] = SvgIcons.rateMyApp;
    appBar[cms(Fields.SideMenu_AboutUsIconAndText).textHeading!] =
    ...
    Get.find<TransferController>().getProfileData();

    return Scaffold(
      backgroundColor: Get.find<AccountController>().isDark?AppConfigs.bf0:AppConfigs.bg2,
      body: SafeArea(
        // top: false,
        child: GetBuilder<AccountController>(builder: (accountController) {
          return Container(
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                              onTap: () => Get.find<MainController>()
                                ..key.currentState?.closeDrawer()
                                ..push(const AppDrawerPage(), AppBars.myProfile,
                                    fromAppDrawer: true),
                              child: Center(
                                child: dashProfileTile(
                                    isDark: accountController.isDark,
                          ...
                          builder: (tsf) {
                            return Padding(
                              ...
                              child: Row(
                                ...
                                children:[
                                  ...List.generate(tsf.profileTotalData.length,(i)=>Container(
                                    height: 100,
                                    width: Get.size.width/3 - 20,
                                    padding: EdgeInsets.symmetric(vertical: 20),
                                    decoration: BoxDecoration(
                                      color: AppConfigs.w,
                                    ...
                                    child: Column(
                                      children: [
                                        Text(tsf.profileTotalData[i].values.first.toString(),style: TS.f28B,),
                                        Text(tsf.profileTotalData[i].keys.first,style: TS.f14.copyWith(color: AppConfigs.primaryColor.withOpacity(0.5)),),
                                      ],
                                    ),
                                  ))
                                ],
                          ...
                          children: titles.asMap().entries.map((entry) {
                            ...
                            return appDrawerTile(
                              ...
                              height: [
                                ...
                                cms(Fields.SideMenu_OffersIconAndText).textHeading!,
                                cms(Fields.SideMenu_MyProfileIconAndText).textHeading!,
