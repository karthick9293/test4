...
import '../../../custom_widgets/utility_icon.dart';
              ...
              children: [
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 30, right: 33, top: 20, bottom: 20),
                        child: Row(
                          ...
                          children: [
                            utilityIcon(
                              ...
                              onTap: () => billPayController.setBillType(BillType.dth),
                            ),
                            utilityIcon(
                              ImagePath.uElectricity,
                              'Electricity'.tr,
                              billPayController.billType == BillType.elec,
                              onTap: () => billPayController.setBillType(BillType.elec),
                            ),
                            utilityIcon(
                              ImagePath.uWifi,
                              'WiFi'.tr,
                              billPayController.billType == BillType.wifi,
                              onTap: () => billPayController.setBillType(BillType.wifi),
                            ),
                            utilityIcon(
                              ImagePath.uGas,
                              'Gas'.tr,
                              billPayController.billType == BillType.gas,
                              onTap: () => billPayController.setBillType(BillType.gas),
                            ),
                          ],
                        ),
                      ),
                      ...
                      textFormField(
                        ...
                        trailing: Container(
                            ...
                            child: SvgPicture.asset(
                              ImagePath.search,
                              colorFilter: ColorFilter.mode(billPayController.isDark ? AppConfigs.g8f : AppConfigs.g4, BlendMode.srcIn),
                            )),
                      ),
                      customDropdown<String>(
                          items: ['Airtel', 'Vi', 'Jio', 'BSNL']
                              .map((e) => DropdownMenuItem<String>(
                                    ...
                                    child: Text(
                                      e,
                                      style: TextStyles.font14.copyWith(color: billPayController.isDark ? AppConfigs.w : AppConfigs.g77),
                                    ),
                                  ))
                              .toList(),
