...
import '../../../custom_widgets/app_bar0.dart';
import '../../../custom_widgets/circular_name_shape.dart';
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(left: 30, top: 30, bottom: 6, right: 29),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("sending_to".tr,
                            style: TextStyles.font12.copyWith(color: const Color(0xff444444), fontWeight: FontWeight.w600),
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 30, right: 23.8, top: 12, bottom: 16),
                      child: Align(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text("Jhon Bruse (Brother)",
                                        style: TextStyles.font14.copyWith(color: const Color(0xff444444), fontWeight: FontWeight.w600),
                                        textAlign: TextAlign.start),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(bottom: 4),
                                    child: Text("cash_pickup".tr,
                                        style: TextStyles.font12.copyWith(color: const Color(0xff444444), fontWeight: FontWeight.w400),
                                        textAlign: TextAlign.start),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(bottom: 4),
                                    child: Text("${'location'.tr} Trivandrum,Kerala  ",
                                        style: TextStyles.font12.copyWith(color: const Color(0xff444444), fontWeight: FontWeight.w400),
                                        textAlign: TextAlign.start),
                                  ),
                                  RichText(
                                    ...
                                    TextSpan(
                                        style: TextStyles.font14.copyWith(color: const Color(0xff444444), fontWeight: FontWeight.w700),
                                        text: "39607.000 INR")
                                  ])),
                                ],
                              ),
                  ...
                  Padding(
                    ...
                    child: Text("you_send".tr,
                        style: TextStyles.font10.copyWith(color: const Color(0xffa29c9c), fontWeight: FontWeight.w600, fontSize: 10.0),
                        textAlign: TextAlign.start),
                  ),
                  Padding(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Opacity(
                            ...
                            child: Container(width: 1, height: 11.6658935546875, decoration: const BoxDecoration(color: Color(0xffb5b5b5))),
                          ),
                        ),
                        Padding(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 58.5, bottom: 7.3),
                          child: Opacity(
                            opacity: 0.4399999976158142,
                            child: Container(width: 1, height: 11.6658935546875, decoration: const BoxDecoration(color: Color(0xffb5b5b5))),
                          ),
                  ...
                  Padding(
                      padding: const EdgeInsets.only(left: 31, right: 33, bottom: 1),
                      child: Text("they_receive".tr,
                          ...
                          textAlign: TextAlign.start)),
                  Padding(
                    padding: const EdgeInsets.only(left: 31, right: 33, bottom: 5.3),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 31, right: 33, bottom: 14.7),
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: Colors.black.withOpacity(transferController.gateWay?.type == e.type ? 0.2 : 0),
                                    ),
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        Visibility(
                                          visible: transferController.gateWay?.type == e.type,
                                          child: Container(
                                            height: 20,
                                            width: 20,
                                            decoration: BoxDecoration(
                                                ...
                                                border: Border.all(color: AppConfigs.primaryColor, width: 5)),
                                          ),
                                        ),
                                        Visibility(
                                          visible: transferController.gateWay?.type == e.type,
                  ...
                  Padding(
                      ...
                      child: Center(
                        child: Container(
                          width: 174,
                          height: 23,
                          decoration: const BoxDecoration(color: Color(0xfffffdb9)),
