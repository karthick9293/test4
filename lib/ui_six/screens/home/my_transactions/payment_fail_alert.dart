...
Widget paymentFailAlert(
    {required String paymentStatus, String? heading, String? message, required InAppWebViewController webViewController, required String url}) {
        ...
        child: Material(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(heading ?? paymentStatus, style: TS.f20.copyWith(color: AppConfigs.der, fontWeight: FontWeight.w600), textAlign: TextAlign.center),
              Padding(
                padding: const EdgeInsets.only(left: 40, right: 40, top: 20, bottom: 10),
                child: Text(
                  message ?? 'We have encounter an unexpected error. Please try again and contact support if the problem continues.',
                  style: TS.f14.copyWith(color: AppConfigs.g4, fontWeight: FontWeight.w600),
              ...
              roundButton(cms(Fields.PopUp_TryAgainButton).textHeading!, bottom: 0, left: 0, right: 0, top: 19, onTap: () {
                Get.back();
              }),
            ],
          ),
