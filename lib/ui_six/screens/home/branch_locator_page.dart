...
import '../../custom_widgets/branch_tile.dart';
      ...
      return Scaffold(
        ...
        body: SafeArea(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Visibility(visible: isPrelogin, child: appBar0('branch_locator'.tr, onTap2: Get.back)),
                textFormField(
                  left: 20,
                  top: 30,
                  bottom: 10,
                ...
                Expanded(
                  child: accountController.branches == null && !accountController.branchFailed
                      ? loader()
                      : accountController.branches == null
                          ...
                          : controller.text.isNotEmpty &&
                                  accountController.branches!
                                      .where((e) =>
                                          e.branchName!.toLowerCase().contains(controller.text.toLowerCase()) ||
                                          e.branchAddress!.toLowerCase().contains(controller.text.toLowerCase()) ||
                                          e.phone!.toLowerCase().contains(controller.text.toLowerCase()) ||
                                          e.landmark!.toLowerCase().contains(controller.text.toLowerCase()) ||
                                          e.longitude!.toLowerCase().contains(controller.text.toLowerCase()) ||
                                          e.longitude!.toLowerCase().contains(controller.text.toLowerCase()))
                                      .toList()
                                      .isEmpty
                              ? Center(
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (c, i) => Visibility(
                                    visible: controller.text.isNotEmpty
                                        ? accountController.branches![i].branchName!.toLowerCase().contains(controller.text.toLowerCase()) ||
                                            accountController.branches![i].latitude.toString().toLowerCase().contains(controller.text.toLowerCase())
                                        : true,
                                    child: branchTile(accountController.branches![i], accountController.isDark),
                                  ),
                                ),
                ),
              ],
