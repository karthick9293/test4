...
import 'package:mobiremit/ui_six/screens/form_rules_form/add_beneficiary_form_rules.dart';
              ...
              children: [
                Expanded(
                  child: Row(
                    ...
                    children: [
                      // Padding(
                      //   padding: const EdgeInsets.only(top: 5, left: 0, right: 9.5),
                      //   child: SvgPicture.asset(
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: _avatarBgColor(
                                  b.name!.removeExtraSpace()[0])),
                          child: Center(
                              child: Text(b.name!.removeExtraSpace()[0],
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          //               child: beneficiaryController.favIndex ==
                          //                       index
                          //                   ? tinyLoader()
                          //                   : SvgPicture.asset(
                          //                       b.fav == 'Y'
                          ...
                          //               child: SvgPicture.asset(
                          //                 ImagePath.editDots,
                          //                 colorFilter: beneficiaryController
                          //                         .isDark
                            ...
                            child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        cms(Fields.MyBeneficiary_SendMoney)
                                            .textHeading!,
                                        style: TS.f12.copyWith(
                                            color: beneficiaryController.isDark
                                                ? AppConfigs.w
...
Color _avatarBgColor(String letter) {
  final colors = [
...
Color _avatarTextColor(String letter) {
  final colors = [
    const Color(0xff123B91),
    const Color(0xff6E45E8),
    const Color(0xff4DB58A),
    const Color(0xff3D97C8),
    const Color(0xffD63A36),
    const Color(0xffC79A2C),
  ];
  return colors[letter.codeUnitAt(0) % colors.length];
}
