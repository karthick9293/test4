...
Widget beneficiaryTile2(
    {required BeneficiaryFz b, required int index, bool isArchive = false, bool moveToTransaction = false, void Function()? favChange}) {
    ...
    return DropdownMenuItem<String>(
      ...
      child: Row(
        children: [
          SvgPicture.asset(
            img,
            colorFilter: ColorFilter.mode(isDark ? AppConfigs.g70 : AppConfigs.primaryColor, BlendMode.srcIn),
          ),
          const SizedBox(width: 8),
          Text(
            s,
            style: TextStyles.font12.copyWith(color: ConstColors.grey4, fontWeight: FontWeight.w600),
          ),
        ],
      ),
    );
  ...
  viewBeneficiary() => Get.find<MainController>().push(ViewBeneficiaryPage(index: index), AppBars.viewBeneficiary);
  return GetBuilder<BeneficiaryController>(builder: (beneficiaryController) {
    return GestureDetector(
      onLongPress: () {
        beneficiaryController
          ..isSelecting = true
          ..markedBeneficiary.add(isArchive ? beneficiaryController.archivedBenefs[index] : beneficiaryController.benefs[index])
          ..update();
      },
      onTap: () {
        if (moveToTransaction) {
          ...
          Get.find<TransferController>()
            ...
            // ..fromBeneficiary = b
            // ..toAmtCur = b.currency
            ..updateToCurrency(s: b.serviceCurrency!.Code, type: 'L'); //TODO: Check to currency update
          ...
          if (beneficiaryController.isSelecting) {
            if (beneficiaryController.markedBeneficiary
                .contains(isArchive ? beneficiaryController.archivedBenefs[index] : beneficiaryController.benefs[index])) {
              beneficiaryController.markedBeneficiary
                  .remove(isArchive ? beneficiaryController.archivedBenefs[index] : beneficiaryController.benefs[index]);
            } else {
              beneficiaryController.markedBeneficiary
                  .add(isArchive ? beneficiaryController.archivedBenefs[index] : beneficiaryController.benefs[index]);
            }
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(bottom: BorderSide(color: ConstColors.grey70.withOpacity(0.1))),
        ),
        child: Row(
          children: [
            Expanded(
                          ...
                          GestureDetector(
                            ...
                            child: SizedBox(
                              ...
                              child: Text(
                                ...
                                maxLines: 2,
                                style: TS.f14
                                    .copyWith(color: beneficiaryController.isDark ? AppConfigs.w : AppConfigs.g4, overflow: TextOverflow.ellipsis),
                              ),
                            ),
                          ),
                          ...
                          GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: beneficiaryController.favIndex == index
                                    ? tinyLoader()
                                    : SvgPicture.asset(b.fav == 'Y' ? ImagePath.bi2 : ImagePath.bi3),
                              )),
                          const Spacer(),
                          Visibility(
                            visible: !beneficiaryController.isSelecting,
                            child: b.active == 'A' && b.isCorrespondentActive == 'Y'
                                ? StatusTiles.activeTile()
                                : b.active == 'N' && b.isCorrespondentActive == 'N'
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              onTap: viewBeneficiary,
                              child: Text(
                                b.serviceType?.Code == ServiceType.BANK_TRANSFER ? '${b.bank} | ${b.accountNumber}' : b.serviceType!.Code,
                                style: TS.f12.copyWith(
                                    color: beneficiaryController.isDark ? AppConfigs.g8f : AppConfigs.g77,
                          ...
                          Visibility(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                ...
                                if (b.active == 'A' && b.isCorrespondentActive == 'Y') {
                                  if (Get.isRegistered<TransferController>()) {
                                    Get.find<TransferController>().reset(t: TransferType.all);
                                  } else {
                                    Get.put(TransferController(transferType: TransferType.all), permanent: true);
                              ...
                              child: SvgPicture.asset(
                                ...
                                colorFilter: ColorFilter.mode(
                                    beneficiaryController.isDark
                                        ? AppConfigs.w
                                        : AppConfigs.g4.withOpacity(b.active == 'A' && b.isCorrespondentActive == 'Y' ? 1 : 0.5),
                                    BlendMode.srcIn),
                              ),
                            ),
                          )
                  ...
                  Visibility(
                    ...
                    child: DropdownButtonHideUnderline(
                      ...
                      items: (Box3.settings.enableEditBenf) && b.active != 'C'
                          ? [
                              ddi(b.active == 'A' && b.isCorrespondentActive == 'Y' ? 'disable'.tr : 'enable'.tr, ImagePath.be2,
                                  beneficiaryController.isDark),
                              ddi('view'.tr, ImagePath.be3, beneficiaryController.isDark),
                      ...
                      onChanged: (v) async {
                        if (v == 'view'.tr) {
                          ...
                          await ApiService()
                              .beneficiarytasks(b.id!.toString(), v == 'enable'.tr ? BeneficiaryTasks.enable : BeneficiaryTasks.disable);
                      ...
                      customButton: Container(
                          ...
                          child: SvgPicture.asset(
                            ImagePath.editDots,
                            colorFilter: beneficiaryController.isDark ? const ColorFilter.mode(AppConfigs.w, BlendMode.srcIn) : null,
                          )),
                    )),
                  )
                ],
