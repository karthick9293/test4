  ...
  Widget build(BuildContext context) {
    return GetBuilder<BeneficiaryController>(builder: (beneficiaryController) {
      ...
      List<TransactionDetailsFz> transactions =
          d.transactions.where((tx) => b.coreBeneficiaryUid?.isNotEmpty == true && tx.bneficiaryId == b.coreBeneficiaryUid).toList();

      return Container(
        padding: EdgeInsets.symmetric(horizontal: 20,vertical: 20),
        decoration: BoxDecoration(
          gradient: beneficiaryController.isDark?null:AppConfigs.linearGradientUiSix
        ),
        child: Column(
          children: [
            lightBlueTile(
              ...
              //       ],
              index: index,
              switchValue: ((b.serviceType?.Code == 'C' || b.serviceType?.Code == 'W') && b.isCorrespondentActive == 'Y')
                  ? (b.active == 'A')
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TS.f12.copyWith(color: beneficiaryController.isDark ? AppConfigs.w : AppConfigs.g4),
                    ),
                  ],
                ),
              ),
              ...
              child: GetBuilder<TransactionController>(builder: (txController) {
                return txController.loading
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (c, i) => benefTransTile(transactions[i], beneficiaryController.isDark),
                      );
              }),
            ),
          ],
