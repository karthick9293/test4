                  ...
                  if (!transferController.listLoading) {
                    transferController
                      ..filteredBenefs = transferController.benefs
                          .where((e) =>
                              (v.isNotEmpty ? e.name!.toLowerCase().contains(v.toLowerCase()) : true) &&
                              ((e.serviceType?.Code == 'C') || (e.serviceType?.Code == 'B') || (e.serviceType?.Code == 'W')) &&
                              e.active == 'A')
                          .toList()
                      ..update();
                  }
                      ...
                      child: transferController.filteredBenefs.isEmpty
                          ...
                          : Scrollbar(
                              ...
                              child: ListView.separated(
                                ...
                                itemCount: transferController.filteredBenefs.length,
                                itemBuilder: (c, i) {
                                  return Visibility(
                                    // visible:
                                    //     transferController.selectedBeneficiary?.id !=
                                    //         transferController.filteredBenefs[i].id,
                                    child: benefTile3(i, transferController.filteredBenefs[i], onTap: () async {
                                      scrollToTop();
                                      transferController.setBenef(transferController.filteredBenefs[i]);
                                    }),
                                  );
                                },
