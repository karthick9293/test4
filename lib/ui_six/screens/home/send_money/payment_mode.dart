...
import 'package:mobiremit/ui_six/custom_widgets/custom_dropdown.dart';
import 'package:mobiremit/ui_six/custom_widgets/dummy_textfield.dart';
import 'package:mobiremit/ui_six/custom_widgets/loader.dart';
import 'package:mobiremit/ui_six/custom_widgets/payment_icon.dart';
import 'package:mobiremit/ui_six/custom_widgets/round_button.dart';
import 'package:mobiremit/ui_six/custom_widgets/text_form_field.dart';
import 'package:mobiremit/ui_six/screens/sign_up/upload_doc_tile.dart';
import 'package:mobiremit/ui_six/shimmers/payment_mode_shimmer.dart';
...
class PaymentModeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<TransferController>(builder: (transferController) {
      return WillPopScope(
        onWillPop: () async {
          return await transferController.showCancelTxnAlert();
        },
        child: Scaffold(
                        ...
                        child: ListView(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                cms(Fields.PaymentConfirmation_SelectPaymentType).textHeading!,
                            ...
                            Container(
                              ...
                              child: ListView(
                                ...
                                children: transferController.payments.map((e) => paymentIcon(e)).toList(),
                              ),
                            ),
                            errorText(transferController.gatewayError),
                            Obx(
                              () => Visibility(
                                visible: transferController.gateWay?.type == 'G' || transferController.gateWay?.type == 'P',
                                child: transferController.loadingPaymentGateway.isTrue
                                    ? PaymentModeShimmers(gatewayOnly: true)
                                    : Container(
                                        padding: const EdgeInsets.fromLTRB(20, 10, 20, 0),
                                        height: 120,
                                        child: ListView(
                                          scrollDirection: Axis.horizontal,
                                          children: transferController.paymentGateways.map((e) => paymentIcon(e)).toList(),
                                        ),
                                      ),
                              ),
                            ),
                            Visibility(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsets.only(left: S.p, top: 10),
                                    child: Row(
                                      children: [
                                        // SvgPicture.asset(
                                        //   ImagePath.info,
                                        ...
                                        Text(
                                          ...
                                          style: TS.f14.copyWith(color: transferController.isDark ? AppConfigs.g8f : AppConfigs.g4),
                                          textAlign: TextAlign.start,
                                        ),
                                      ],
                                    ),
                                  ),
                                  transferController.banksList.length == 1 && BankAttributes.drawingBank != null
                                      ? dummyTextField(BankAttributes.drawingBank!.bankName, transferController.isDark)
                                      : customDropdown<DrawingBankFz>(
                                          ...
                                          items: transferController.banksList
                                              .map(
                                                (e) => DropdownMenuItem<DrawingBankFz>(value: e, child: Text(e.bankName)),
                                              )
                                              .toList(),
                                          onChanged: (b) {
                                            if (b != null) {
                                              ...
                                              if (transferController.accountNumbers.length == 1) {
                                                BankAttributes.payAccountNumber = b.payAccountNumbers[0];
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(left: S.p, top: 10),
                                    child: Text('${(Box3.settings.clientName)} ${'account_number'.tr}*',
                                        style: TextStyles.font12.copyWith(color: transferController.isDark ? AppConfigs.g8f : AppConfigs.g4),
                                        textAlign: TextAlign.start),
                                  ),
                                  transferController.accountNumbers.length == 1 && BankAttributes.payAccountNumber != null
                                      ? dummyTextField(
                                  ...
                                  textFormField(
                                      ...
                                      labelText: '${'Payment_reference_number'.tr} *',
                                      onChanged: (s) {
                                        if (s.isNotEmpty && BankAttributes.paymentReferenceNumberError.isNotEmpty) {
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Text('${"Upload Receipt/Bill".tr} ${'optional'.tr}',
                                  ...
                                  Padding(
                                    ...
                                    child: docTile(
                                      ...
                                      delete: () => transferController
                                        ..bill = null
                                        ..update(),
                                      onTap: () async => Get.find<KycController>()
                                          .openDocSheet(type: KYCType.BILL_RECEIPT, isFront: null, isCrop: false, isFromReceipt: true),
                            ...
                            Visibility(
                              visible: (transferController.gateWay?.type == 'D')
                                  ? true
                                  : transferController.gateWay?.type == 'D' && transferController.gateWay?.description != 'Instant Bank Transfer',
                              // visible: transferController.gateWay?.type == 'D' &&
                                ...
                                child: Column(
                                  children: [
                                    customDropdown<DebitBankBV>(
                                        ...
                                        error: transferController.debitBankError.isNotEmpty,
                                        items: transferController.debitBanks
                                            .map(
                                              (e) => DropdownMenuItem<DebitBankBV>(
                                                value: e,
                        ...
                        : roundButton(
                            ...
                            child: Box3.settings.requiredCurrencySymbol == false
                                ...
                                : Row(
                                    ...
                                    children: [
                                      Text(
                                        cms(Fields.PaymentConfirmation_PayButton).textHeading!,
                                      ...
                                      CurrencySymbolWithAmount(
                                        ...
                                        amount: '${transferController.rateCharge?.netAmount?.toStringWithOptionalFixed(length)}',
                                        color: AppConfigs.w,
