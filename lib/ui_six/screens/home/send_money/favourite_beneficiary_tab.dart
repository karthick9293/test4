                  ...
                  if (!transferController.listLoading) {
                    transferController
                      ..filteredFavBenefs = transferController.favBenefs
                          .where((e) =>
                              (v.isNotEmpty ? e.firstName!.toLowerCase().contains(v.toLowerCase()) : true) &&
                              ((e.serviceType?.Code == ServiceType.CASH_PICKUP) || (e.serviceType?.Code == ServiceType.BANK_TRANSFER)) &&
                              e.active == 'A')
                          .toList()
                      ..update();
                  }
                  ...
                  : Scrollbar(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (c, i) => benefTile3(
                          ...
                          onTap: () async {
                            scrollToTop();
                            transferController.setBenef(transferController.filteredFavBenefs[i]);
                          },
                        ),
                      ),
                    ),
