              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${'Alert'.tr}!',
                      style: TS.f20.copyWith(color: accountController.isDark ? AppConfigs.w : AppConfigs.bf0),
                    ),
                    ...
                    accountController.retryLoading
                        ...
                        : roundButton('Retry'.tr, noMar: true, onTap: () async {
                            Get.toNamed(AppRoutes.notificationNotExpiredRetryRoutesUAEPASS, arguments: {
                              "token": Get.find<SignUpController>().uaePassAuthToken ?? '',
                              "emiratesID": Get.find<SignUpController>().uaePassProfileFz?.idn ?? '',
                              "documentType": Get.find<SignUpController>().uaePassProfileFz?.nationalityEN == 'ARE'
                                  ? 'Passport'
                                  : gccCountries.contains(Get.find<SignUpController>().uaePassProfileFz?.nationalityEN)
                                      ? ""
                                      : 'ResidenceVisa',
                    ...
                    roundButton('cancel'.tr, noMar: true, onTap: () {
                      accountController.logoutAlert(title: 'Alert', description: 'Are you sure want to close this session', yes: 'Yes', no: 'No');
                    }),
                  ],
                ),
              ),
