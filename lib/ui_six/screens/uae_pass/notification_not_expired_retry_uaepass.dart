                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        'UAE PASS',
                        style: TS.f22.copyWith(fontWeight: FontWeight.bold, color: AppConfigs.contentTextWhite2(signUpController.isDark)),
                      )
                    ],
                  ),
                  Text(
                    'UAE PASS Document Sharing',
                    style: TS.f18.copyWith(color: AppConfigs.contentTextWhite2(signUpController.isDark)),
                  ),
                  const SizedBox(height: 10),
                  Text(
                    'Share authentic and up to date documents eliminating the need for paper and physical visits',
                    style: TS.f14.copyWith(color: AppConfigs.contentTextWhite2(signUpController.isDark)),
                  ),
                  const SizedBox(height: 15),
                  Container(
                    decoration: BoxDecoration(color: AppConfigs.g8f.withOpacity(0.14), borderRadius: const BorderRadius.all(Radius.circular(15))),
                    padding: const EdgeInsets.all(15),
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Please ensure',
                          style: TS.f14.copyWith(fontWeight: FontWeight.bold, color: AppConfigs.contentTextWhite2(signUpController.isDark)),
                        ),
                  ...
                  signUpController.uaePassLoading
                      ...
                      : UAEButton(
                          ...
                          onTap: () async {
                            ...
                            await ApiService().openUAEPassDoc(token: token, emiratesID: emiratesID, documentType: documentType, uuid: uuid);
                          },
                        ),
                  HyperLinkButton(
                    'Cancel',
                    onTap: () {
                      signUpController.logoutAlert(title: 'Alert', description: 'Are you sure want to close the application', yes: 'Yes', no: 'No');
                    },
                  )
                ],
              ),
