  ...
  return Box3.settings.EnableSwipeButton == true
      ? Container(
          ...
          margin: noMar
              ? EdgeInsets.zero
              : EdgeInsets.fromLTRB(
                  left ?? S.p, top ?? 0, right ?? S.p, bottom ?? S.p),
          width: width,
          key: key,
          ...
          child: SwipeButton.expand(
            ...
            activeThumbColor:
                isLoading ? Colors.transparent : AppConfigs.swipeYesColor,
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.all(
                    Radius.circular(height != null ? (height / 2) : 28)),
                border: Border.all(
                    color: isLoading
                        ? AppConfigs.primaryColor.withOpacity(0)
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.all(
                    Radius.circular(height != null ? (height / 2) : 28)),
                border: Border.all(
                    color: borderColor ?? ConstColors.primary, width: 2)),
            alignment: Alignment.center,
            child: Text(
              text,
              style: TS.f16.copyWith(
