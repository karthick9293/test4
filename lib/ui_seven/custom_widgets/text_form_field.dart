      ...
      children: [
        ...
        Container(
          ...
          margin: noPad
              ...
              : EdgeInsets.fromLTRB(
                  left ?? S.p,
                  Box3.primaryUI == AppUI.defaultUI ? top ?? 10 : 5,
                  right ?? S.p,
                  bottom ?? 0),
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        contentPadding: contentPadding ??
                            EdgeInsets.fromLTRB(15, disableBorder ? 10 : 0, 15,
                                disableBorder ? 13 : 20),
                        hintText: hintText,
                        labelText: labelText,
...
Widget errorText(String text,
  ...
  return Visibility(
    ...
    child: Container(
      margin:
          EdgeInsets.only(right: S.p, top: 3, left: S.p, bottom: marginBottom),
      alignment: alignment,
      child: Text(text,
          style: TS.f12
              .copyWith(color: AppConfigs.der, fontWeight: FontWeight.w600),
          textAlign: TextAlign.start),
    ),
  );
}
