...
class ReportFraudPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GlobalScaffold(
      ...
      body: Container(
        padding:
            const EdgeInsets.only(top: 0, right: 1.0, left: 8.0, bottom: 10),
        child: Scrollbar(
