          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Enter_your_own_question_below_box_and_submit".tr,
                  ...
                  ? roundButton(
                      ...
                      onTap: () async {
                        if (FAQControllers.faq.text.trim().isNotEmpty) {
                          if (accountController.appStatus ==
                              AppStatus.loggedIn) {
                            accountController
                              ..feedbackStatus.value = true
                              ..update();
                            bool data = await ApiService().sendFeedback(
                                FAQControllers.faq.text,
