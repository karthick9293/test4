...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AccountController>(builder: (accountController) {
      ...
      return accountController.myProfileFormLoading
          ? ProfileShimmers()
                  ...
                  children: [
                            ...
                            child: Stack(
                              children: [
                                Container(
                                  ...
                                  child: accountController.selfieImage.value !=
                                          null
                                      ? ClipRRect(
                                          borderRadius:
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          // Text(
                          //   cms(Fields.MyProfile_EKYCDetails).textHeading!,
                          ...
                          //   children: [
                          //     Text(
                          //       '${Box3.settings.primaryDocID} ${cms(Fields.MyProfile_QatarIdFrontPage).textHeading!}',
                          //       style: TS.f12.copyWith(
                          //         color: accountController.isDark
                          //             ? AppConfigs.w
                          //             : AppConfigs.g77,
                          ...
                          //         ..showIDFront = !accountController.showIDFront
                          //         ..update(),
                          //       child: SvgPicture.asset(
                          //         ImagePath.viewPassword,
                          //         width: 20,
                          //         colorFilter: ColorFilter.mode(
                          //             accountController.isDark
                          //                 ? AppConfigs.g8f
                          //                 : AppConfigs.bf0.withOpacity(0.54),
                          //             BlendMode.srcIn),
                          //       ),
                          //     ),
                          //   ],
                          // ),
                          // Visibility(
                          //   visible: accountController.showIDFront,
                          //   child: (accountController.frontImage != null)
                          //       ? Base64Image(
                          //           image: accountController.frontImage ?? '',
                          //           fit: BoxFit.cover,
                          ...
                          //   children: [
                          //     Text(
                          //       '${Box3.settings.primaryDocID} ${cms(Fields.MyProfile_QatarIdBackPage).textHeading!}',
                          //       style: TS.f12.copyWith(
                          //         color: accountController.isDark
                          //             ? AppConfigs.w
                          //             : AppConfigs.g77,
                          ...
                          //     GestureDetector(
                          //       onTap: () => accountController
                          //         ..showIDBack = !accountController.showIDBack
                          //         ..update(),
                          //       child: SvgPicture.asset(
                          //         ImagePath.viewPassword,
                          //         width: 20,
                          ...
                          // ),
                          // Visibility(
                          //   visible: accountController.showIDBack,
                          //   child: (accountController.backImage != null)
                          //       ? Base64Image(
                          //           image: accountController.backImage ?? '',
                          //           fit: BoxFit.cover,
                          //           alignment: Alignment.center,
                          //         )
                          //       : Text(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => AnimatedSmoothIndicator(
                                    activeIndex:
                                        accountController.idSideActiveIdx.value,
                                    count: 2,
                                    effect: SwapEffect(
