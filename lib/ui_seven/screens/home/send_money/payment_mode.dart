                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              cms(Fields.PaymentConfirmation_SelectPaymentType)
                                  .textHeading!,
                          ...
                          Obx(
                            () => Visibility(
                              visible:
                                  transferController.gateWay?.type == 'G' ||
                                      transferController.gateWay?.type == 'P',
                      ...
                      : roundButton(
                          ...
                          child: Box3.settings.requiredCurrencySymbol == false
                              ...
                              : Row(
                                  ...
                                  children: [
                                    Text(
                                      cms(Fields.PaymentConfirmation_PayButton)
                                          .textHeading!,
                                      style:
                                          TS.f16.copyWith(color: AppConfigs.w),
                                    ),
                                    SizedBox(
                                      width: 5,
                                    ),
                                    CurrencySymbolWithAmount(
                                      currencyWidth: 13,
                                      currencyCode: Box3.companyDataFZ!
