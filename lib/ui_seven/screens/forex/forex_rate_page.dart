    ...
    return GetBuilder<AccountController>(
        ...
        builder: (accountController) {
            ...
            child: Column(
              children: [
                Visibility(
                  visible: isPrelogin,
                  child: appBar0(
                    cms(Fields.ForexRates_PageHeading).textHeading!,
                    onTap2: Get.back,
                  ),
                ),
                SizedBox(height: 10),
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border:
                          Border.all(color: AppConfigs.primaryColor, width: 2),
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(100),
                                color: accountController.forexType == 'buy'
                              ...
                              child: Text(
                                  cms(Fields.ForexRates_BuyRate).textHeading!,
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(100),
                                color: accountController.forexType == 'sell'
                                    ? AppConfigs.primaryColor
                                    : accountController.isDark
                                        ? AppConfigs.b
                                        : AppConfigs.w,
                              ...
                              alignment: Alignment.center,
                              child: Text(
                                  cms(Fields.ForexRates_SellRate).textHeading!,
                                  style: TS.f14.copyWith(
                                      color:
                                          accountController.forexType == 'sell'
                                              ? AppConfigs.w
                                              : AppConfigs.primaryColor)),
                            ),
                          ),
                ...
                textFormField(
                    hintText:
                        cms(Fields.ForexRates_SearchCurrency).textHeading!,
                    controller: controller,
                    onChanged: (v) => accountController.getFilterRate(v),
                    trailing: Container(
                      width: 40,
                      alignment: Alignment.center,
                    ...
                    child: accountController.rates == null
                        ...
                        : accountController.filterRates!.isEmpty
                            ...
                            : ListView.builder(
                                ...
                                itemCount:
                                    accountController.filterRates!.length,
                                itemBuilder: (c, i) {
          ...
          return GlobalScaffold(
            ...
            body: isPrelogin ? SingleChildScrollView(child: body) : body,
          );
        });
  }
}
