...
class SetForexRatePage extends GetView {
  const SetForexRatePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Material(
      color: acContrl.isDark ? AppConfigs.b : AppConfigs.w,
      child: ListView(
        ...
        children: [
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                  cms(Fields.ForexBooking_CurrencyYouHave)
                                      .textHeading!,
                                  style: TS.f12.copyWith(
                                      color: acContrl.isDark
                                          ? AppConfigs.g8f
                                  ...
                                  textAlign: TextAlign.start),
                              Text(
                                  cms(Fields.ForexBooking_ForexBookingCurrency)
                                      .textHeading!,
                                  style: TS.f12.copyWith(
                                      color: acContrl.isDark
                                          ? AppConfigs.g8f
                        ...
                        children: [
                          ...
                          dateField(
                            ...
                            erfc: (b, {DateTime? date}) {
                              ...
                              accountController.fBA!.forexDateError =
                                  b ? '' : 'Invalid_date'.tr;
                          ...
                          textFormField(
                            ...
                            errorText: accountController.fBA!.remarkError,
                            hintText:
                                cms(Fields.ForexBooking_Remarks).textHeading!,
                            textInputAction: TextInputAction.done,
                            onChanged: (s) {},
                          ),
                        ],
          ...
          GetBuilder<AccountController>(builder: (accountController) {
            return Column(
              children: [
                if (cms(Fields.ForexBooking_RateMessage)
                        .status
                        ?.toLowerCase() ==
                    "a")
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: AppConfigs.accentColor.withAlpha(30),
                                    ...
                                    TextSpan(
                                        style: TS.f14.copyWith(
                                            color: accountController.isDark
                                                ...
                                                : AppConfigs.g4),
                                        text:
                                            '${cms(Fields.ForexBooking_IHaveRead).textHeading!} '),
                                    TextSpan(
                                      style: TS.f14.copyWith(
                ...
                accountController.fBA!.isLoading
                    ? loader()
                    : roundButton(
                        cms(Fields.ForexBooking_CreateBookingButton)
                            .textHeading!,
                        bottom: 20, onTap: () async {
                        ...
                        if (status) {
                          accountController
                            ..fBA!.isLoading = true
                            ..update();
                          CustomMessageDetailsFZ? customMsgDetails =
                              await ApiService().setForexRate(
                                  ...
                                  date: DateFormat("dd/MMM/yyyy")
                                      .format(DateTime(
                                          int.parse(accountController
                                              .fBA!.forexDateCtrls[2].text),
                                          int.parse(accountController
                                              .fBA!.forexDateCtrls[1].text),
                                          int.parse(accountController.fBA!.forexDateCtrls[0].text)))
                                      .toString(),
                          ...
                          if (customMsgDetails != null) {
                            customMsgDetails.MessageType == 'SUCCESS'
                                ? showSuccessAlert(
                                    ...
                                    content:
                                        customMsgDetails.MessageDescription,
                                    function: () {
                                      Get.back();
                                    },
                                  )
