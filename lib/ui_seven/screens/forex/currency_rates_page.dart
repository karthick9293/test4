                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color: accountController.currencyRatesType ==
                                          'rates'
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              accountController.updateToCurrencyCalc(
                                  ...
                                  type: 'L',
                                  currency: accountController.calculatorToCur !=
                                          null
                    ...
                    : accountController.currencyRatesType == 'rates'
                        ? Expanded(
                            child: Column(
                              children: [
                                textFormField(
                                    labelText: cms(Fields.CurrencyRates_Search)
                                        .textHeading,
                                    controller: controller,
                                    onChanged: (v) =>
                                        accountController.update(['all-rates']),
                                    bottom: 10,
                                    top: 20,
                                    borderRadius: 50,
                                    trailing: Container(
