        ...
        return AnimatedPositioned(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isExpanded
                  ? (isDark
                      ? const Color(0xFF0B0F1E).withOpacity(0.95)
              ...
              borderRadius: BorderRadius.circular(isExpanded ? 30 : 22),
              border: Border.all(
                color: isDark
                    ? (isExpanded
            ...
            child: ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: isExpanded
                    ...
                    : _buildCollapsedContent(context, controller, isDark),
              ),
            ),
          ),
        );
            ...
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  color: isDark ? Colors.white : AppConfigs.primaryColor,
                  size: 22,
                ),
              ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            "LATEST UPDATES",
                            style: TextStyle(
                              color: isDark ? Colors.white70 : AppConfigs.primaryColor,
                              fontSize: 9,
                        ...
                        builder: (controller) {
                          ...
                          return Marquee(
                            ...
                            style: TextStyle(
                              color: isDark
                                  ? Colors.white
                                  : AppConfigs.primaryColor.withOpacity(0.9),
                              fontSize: 14,
